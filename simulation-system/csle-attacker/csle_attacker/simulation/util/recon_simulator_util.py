...
class ReconSimulatorUtil:
    ...
    def simulate_host_scan_helper(s: EmulationEnvState, a: EmulationAttackerAction,
        ...
        :param emulation_env_config: the current environment configuration
        ...
        # Scan a whole subnetwork
            ...
            attacker_machine_observations = EnvDynamicsUtil.merge_new_obs_with_old(
                s.attacker_obs_state.machines, new_m_obs, emulation_env_config=emulation_env_config, action=a)
            s_prime = s
            s_prime.attacker_obs_state.machines = attacker_machine_observations
