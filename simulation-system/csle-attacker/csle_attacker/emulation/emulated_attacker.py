...
class EmulatedAttacker:
    ...
    @staticmethod
    def attacker_recon_action(s: EmulationEnvState, a: EmulationAttackerAction, emulation_env_config: EmulationEnvConfig) \
            -> EmulationEnvState:
        """
    ...
    def attacker_exploit_action(s: EmulationEnvState, a: EmulationAttackerAction,
        ...
        if a.id == EmulationAttackerActionId.TELNET_SAME_USER_PASS_DICTIONARY_HOST \
            ...
            return ExploitMiddleware.execute_telnet_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_ssh_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_ftp_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_cassandra_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_irc_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_mysql_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_smtp_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
            ...
            return ExploitMiddleware.execute_postgres_same_user_dictionary(
                s=s, a=a, emulation_env_config=emulation_env_config)
