...
class DefenderBeliefStateSimulator:
    ...
    def update_state(s, attacker_action: AttackerAction, env_config: CSLEEnvConfig,
        ...
        s_prime.defender_obs_state.sum_priority_alerts_total_all_stops = \
            s_prime.defender_obs_state.sum_priority_alerts_total_all_stops + num_new_priority
        ...
        s_prime.defender_obs_state.num_warning_alerts_total = \
            s_prime.defender_obs_state.num_warning_alerts_total + num_new_warning_alerts
        s_prime.defender_obs_state.num_warning_alerts_total_all_stops = \
            s_prime.defender_obs_state.num_warning_alerts_total_all_stops + num_new_warning_alerts
        ...
        s_prime.defender_obs_state.num_severe_alerts_total = \
            s_prime.defender_obs_state.num_severe_alerts_total + num_new_severe_alerts
        s_prime.defender_obs_state.num_severe_alerts_total_all_stops = \
            s_prime.defender_obs_state.num_severe_alerts_total_all_stops + num_new_severe_alerts
