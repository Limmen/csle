...
from csle_common.agents.openai_baselines.common.policies import BasePolicy, ContinuousCritic, register_policy
from csle_common.agents.openai_baselines.common.torch_layers import BaseFeaturesExtractor, FlattenExtractor, NatureCNN, create_mlp
...
class Actor(BasePolicy):
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = False, env_config : BaseCSLEEnvConfig = None,
...
class TD3Policy(BasePolicy):
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = False,
                 env_config: BaseCSLEEnvConfig = None, env_state: BaseEnvState = None, m_index : int = None) -> th.Tensor:
