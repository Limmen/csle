...
from csle_common.agents.openai_baselines.common.save_util import load_from_zip_file, recursive_getattr, \
    recursive_setattr, save_to_zip_file
from csle_common.dao.agent.train_mode import TrainMode

from csle_common.agents.openai_baselines.common.utils import (
...
from csle_common.agents.openai_baselines.common.callbacks import BaseCallback, CallbackList, ConvertCallback, EvalCallback
from csle_common.agents.openai_baselines.common.vec_env import DummyVecEnv, VecEnv, VecNormalize, VecTransposeImage, unwrap_vec_normalize, SubprocVecEnv
from csle_common.agents.openai_baselines.common.policies import BasePolicy, get_policy_from_name
...
from csle_common.agents.util.log_util import LogUtil
...
class BaseAlgorithm(ABC):
    ...
    def predict(
            ...
            env_config : BaseCSLEEnvConfig = None,
            env_configs: List[BaseCSLEEnvConfig] = None,
