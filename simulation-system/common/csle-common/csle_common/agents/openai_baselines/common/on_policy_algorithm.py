...
from csle_common.agents.openai_baselines.common.buffers import RolloutBuffer, RolloutBufferAR
from csle_common.agents.openai_baselines.common.type_aliases import GymEnv, MaybeCallback
from csle_common.agents.openai_baselines.common.vec_env import VecEnv
from csle_common.agents.openai_baselines.common.callbacks import BaseCallback
from csle_common.agents.openai_baselines.common.base_class import BaseAlgorithm
from csle_common.agents.openai_baselines.common.policies import ActorCriticPolicy
from csle_common.agents.config.agent_config import AgentConfig
from csle_common.agents.openai_baselines.common.evaluation import quick_evaluate_policy
        ...
        while self.iteration < num_iterations:
            ...
            if self.iteration % self.attacker_agent_config.train_log_frequency == 0 or self.iteration == 1:
                if self.attacker_agent_config.train_progress_deterministic_eval:
                    ...
                    if self.defender_agent_config is not None and self.defender_agent_config.static_eval_defender:
                        train_log_dto = self.eval_util.eval_defender(
                            self.env.envs[0], self, train_log_dto=train_log_dto,
                            deterministic=self.attacker_agent_config.eval_deterministic)
