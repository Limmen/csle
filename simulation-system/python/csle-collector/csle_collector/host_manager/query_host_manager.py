...
def get_host_monitor_status(
    ...
    host_monitor_dto = stub.getHostMonitorStatus(get_host_monitor_status_msg, timeout=timeout)
...
def start_host_monitor(stub: csle_collector.host_manager.host_manager_pb2_grpc.HostManagerStub,
    ...
    host_monitor_dto = stub.startHostMonitor(start_host_monitor_msg, timeout=timeout)
    return host_monitor_dto


def stop_host_monitor(
        stub: csle_collector.host_manager.host_manager_pb2_grpc.HostManagerStub,
        timeout=constants.GRPC.TIMEOUT_SECONDS) -> csle_collector.host_manager.host_manager_pb2.HostMonitorDTO:
    """
    ...
    host_monitor_dto = stub.stopHostMonitor(stop_host_monitor_msg, timeout=timeout)
    return host_monitor_dto
