    ...
    def set_config_parameters_from_config_file() -> None:
        ...
        try:
            with io.open(config_file_path, 'r', encoding='utf-8') as f:
                ...
                constants.CSLE_ADMIN.MANAGEMENT_USER = config_dict["management_admin_username"]
                constants.CSLE_ADMIN.MANAGEMENT_PW = config_dict["management_admin_password"]
                constants.CSLE_ADMIN.MANAGEMENT_EMAIL = config_dict["management_admin_email"]
                constants.CSLE_ADMIN.MANAGEMENT_ORGANIZATION = config_dict["management_admin_organization"]
                constants.CSLE_ADMIN.MANAGEMENT_FIRST_NAME = config_dict["management_admin_first_name"]
                constants.CSLE_ADMIN.MANAGEMENT_LAST_NAME = config_dict["management_admin_last_name"]
                constants.CSLE_ADMIN.SSH_USER = config_dict["ssh_admin_username"]
                constants.CSLE_ADMIN.SSH_PW = config_dict["ssh_admin_password"]
                constants.CSLE_GUEST.MANAGEMENT_USER = config_dict["management_guest_username"]
                constants.CSLE_GUEST.MANAGEMENT_PW = config_dict["management_guest_password"]
                constants.CSLE_GUEST.MANAGEMENT_EMAIL = config_dict["management_guest_email"]
                constants.CSLE_GUEST.MANAGEMENT_ORGANIZATION = config_dict["management_guest_organization"]
                constants.CSLE_GUEST.MANAGEMENT_FIRST_NAME = config_dict["management_guest_first_name"]
                constants.CSLE_GUEST.MANAGEMENT_LAST_NAME = config_dict["management_guest_last_name"]
