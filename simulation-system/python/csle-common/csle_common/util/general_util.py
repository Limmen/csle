...
class GeneralUtil:
    ...
    def set_config_parameters_from_config_file() -> None:
        ...
        config_file_path = f"{csle_home}{constants.COMMANDS.SLASH_DELIM}" \
                           f"{constants.CONFIG_FILE.CONFIG_FILE_NAME}"
        try:
            config_dict = GeneralUtil.read_config_file()
            constants.CSLE_ADMIN.MANAGEMENT_USER = config_dict["management_admin_username_default"]
            constants.CSLE_ADMIN.MANAGEMENT_PW = config_dict["management_admin_password_default"]
            constants.CSLE_ADMIN.MANAGEMENT_EMAIL = config_dict["management_admin_email_default"]
            constants.CSLE_ADMIN.MANAGEMENT_ORGANIZATION = config_dict["management_admin_organization_default"]
            constants.CSLE_ADMIN.MANAGEMENT_FIRST_NAME = config_dict["management_admin_first_name_default"]
            constants.CSLE_ADMIN.MANAGEMENT_LAST_NAME = config_dict["management_admin_last_name_default"]
            constants.CSLE_ADMIN.SSH_USER = config_dict["ssh_admin_username_default"]
            constants.CSLE_ADMIN.SSH_PW = config_dict["ssh_admin_password_default"]
            constants.CSLE_GUEST.MANAGEMENT_USER = config_dict["management_guest_username_default"]
            constants.CSLE_GUEST.MANAGEMENT_PW = config_dict["management_guest_password_default"]
            constants.CSLE_GUEST.MANAGEMENT_EMAIL = config_dict["management_guest_email_default"]
            constants.CSLE_GUEST.MANAGEMENT_ORGANIZATION = config_dict["management_guest_organization_default"]
            constants.CSLE_GUEST.MANAGEMENT_FIRST_NAME = config_dict["management_guest_first_name_default"]
            constants.CSLE_GUEST.MANAGEMENT_LAST_NAME = config_dict["management_guest_last_name_default"]
            constants.AGENT.USER = config_dict["ssh_agent_username"]
            constants.AGENT.PW = config_dict["ssh_agent_password"]
            ...
            constants.COMMANDS.MANAGEMENT_SYSTEM_PORT = config_dict["monitor_port"]
            ...
            constants.COMMANDS.MANAGEMENT_SYSTEM_PID_FILE = config_dict["monitor_pid_file"]
