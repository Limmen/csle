...
| `/gaussian-mixture-system-models`                                        | List of gaussian mixture system-models                         | `GET`,`DELETE`                          |
| `/gaussian-mixture-system-models?id=true`                                | List of gaussian mixture system-model ids only (fast to fetch) | `GET`,`DELETE`                          |
| `/gaussian-mixture-system-models/<trace_id>`                             | Individual gaussian mixture system model                       | `GET`,`DELETE`                          |
| `/empirical-system-models`                                               | List of empirical system-models                                | `GET`,`DELETE`                          |
| `/empirical-system-models?id=true`                                       | List of empirical system-model ids only (fast to fetch)        | `GET`,`DELETE`                          |
| `/empirical-system-models/<trace_id>`                                    | Individual empirical system model                              | `GET`,`DELETE`                          |
| `/gp-system-models`                                                      | List of gp system-models                                       | `GET`,`DELETE`                          |
| `/gp-system-models?id=true`                                              | List of gp system-model ids only (fast to fetch)               | `GET`,`DELETE`                          |
| `/gp-system-models/<trace_id>`                                           | Individual gp system model                                     | `GET`,`DELETE`                          |
| `/system-models?id=true`                                                 | List of all system model ids (fast to fetch)                   | `GET`                                   |
