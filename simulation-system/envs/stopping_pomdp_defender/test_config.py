...
class TestSimulationConfigSuite:
    """
    Test suite for the simulation configuration for 'stopping-pomdp-defender'
    """
    ...
    def test_create_config_v001(self) -> None:
        ...
        :return: None
        """
        config = default_config_v_001(name="csle-stopping-pomdp-defender-001", version="0.0.1")
    ...
    def test_create_config_v002(self) -> None:
        ...
        :return: None
        """
        config = default_config_v_002(name="csle-stopping-pomdp-defender-002", version="0.0.2")
        assert config.players_config is not None
        assert config.state_space_config is not None
        assert config.joint_action_space_config is not None
        assert config.joint_observation_space_config is not None
    ...
    def test_create_config_v003(self) -> None:
        ...
        :return: None
        """
        config = default_config_v_003(name="csle-stopping-pomdp-defender-003", version="0.0.3")
        assert config.players_config is not None
        assert config.state_space_config is not None
        assert config.joint_action_space_config is not None
        assert config.joint_observation_space_config is not None
