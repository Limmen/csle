...
def start_explore_threads(num_threads : int, env_name : str, num_steps: int = 10000000):
    ...
    for thread_id in range(num_threads):
        ...
        thread = ExploreThread(env_name=env_name, num_steps = num_steps, port_start=4200 + thread_id*100)
        thread.start()
        time.sleep(180)
...
if __name__ == '__main__':
    start_explore_threads(num_threads=2, env_name="csle-ctf-level-6-emulation-v4",
                          num_steps=10000000)
