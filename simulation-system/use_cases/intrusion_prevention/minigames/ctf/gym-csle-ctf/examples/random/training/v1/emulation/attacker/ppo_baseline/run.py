...
def default_config() -> ClientConfig:
    ...
    #env_name = "csle-ctf-random-emulation-v1"
    env_name = "csle-ctf-random-generated-sim-v1"
    #env_name = "csle-ctf-random-emulation-costs-v1"
    ...
    client_config = ClientConfig(env_name=env_name, attacker_agent_config=agent_config,
                                 ...
                                 randomized_env=True, train_mode=TrainMode.TRAIN_ATTACKER)
