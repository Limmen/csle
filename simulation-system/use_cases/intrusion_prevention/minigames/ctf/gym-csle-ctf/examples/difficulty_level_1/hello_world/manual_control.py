...
def manual_control():
    ...
    #env = gym.make("csle-ctf-level-1-emulation-v4", env_config=None, emulation_config=emulation_config)
    #env = gym.make("csle-ctf-level-1-emulation-v1", env_config=None, emulation_config=emulation_config)
    env = gym.make("csle-ctf-level-1-emulation-v1", env_config=None, emulation_config=emulation_config)
    #env = gym.make("csle-ctf-level-1-emulation-costs-v1", env_config=None, emulation_config=emulation_config)
    #env = gym.make("csle-ctf-level-1-sim-v1", env_config=None, emulation_config=emulation_config)
