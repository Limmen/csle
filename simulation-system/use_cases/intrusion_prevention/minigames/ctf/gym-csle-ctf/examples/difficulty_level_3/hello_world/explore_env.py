...
class ExploreThread(threading.Thread):
    ...
    def run(self):
        # emulation_config = emulationConfig(server_ip="172.31.212.91", agent_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}3g.191",
...
if __name__ == '__main__':
    start_explore_threads(num_threads=15, env_name="csle-ctf-level-3-emulation-v4",
                          num_steps=10000000)
