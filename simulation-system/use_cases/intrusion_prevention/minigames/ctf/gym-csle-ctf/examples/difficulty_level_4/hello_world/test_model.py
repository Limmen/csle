...
def model_test():
    ...
    load_path = "/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion/ctf/gym-csle-ctf/examples/difficulty_level_4/training/v5/generated_simulation/defender/ppo_baseline/results/data/1617774810.573099_policy_network.zip"
    load_path = "/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion/ctf/gym-csle-ctf/examples/difficulty_level_4/training/v5/generated_simulation/defender/ppo_baseline/results/data/1617775844.7080226_policy_network.zip"
    load_path = "/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion/ctf/gym-csle-ctf/examples/difficulty_level_4/training/v5/generated_simulation/defender/ppo_baseline/results/data/1617776883.0189135_policy_network.zip"
...
def model_eval():
    ...
    emulation_config = EmulationConfig(server_ip="172.31.212.92", agent_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}4.191",
                                       ...
                                       server_username="kim", port_forward_next_port=3000)
    env = gym.make("csle-ctf-level-4-emulation-v5", env_config=None, emulation_config=emulation_config)
    load_path = "/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion/ctf/gym-csle-ctf/examples/difficulty_level_4/training/v5/generated_simulation/defender/ppo_baseline/results/data/1617785905.6911762_0_50_policy_network.zip"
    model = initialize_model(env, load_path, "cpu:0", None)
