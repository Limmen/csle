...
def default_config() -> ClientConfig:
    ...
    env_name = "csle-ctf-level-4-emulation-v5"
    #env_name = "csle-ctf-level-4-emulation-costs-v5"
    emulation_config = EmulationConfig(agent_ip="172.18.4.191", agent_username="agent", agent_pw="agent",
                                     server_connection=False, warmup=True, warmup_iterations=100,
    ...
    client_config = ClientConfig(env_name=env_name, attacker_agent_config=agent_config,
                                 ...
                                 title="PPO level_4 v5 emulation",
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_4 v5 emulation"
