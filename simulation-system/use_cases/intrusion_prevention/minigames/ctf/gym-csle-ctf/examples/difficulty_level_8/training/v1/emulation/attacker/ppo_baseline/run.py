...
def default_config() -> ClientConfig:
    ...
    env_name = "csle-ctf-level-8-emulation-v1"
    #env_name = "csle-ctf-level-8-emulation-costs-v1"
    ...
    client_config = ClientConfig(env_name=env_name, attacker_agent_config=agent_config,
                                 ...
                                 title="PPO level_8 v1 emulation",
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_8 v1 emulation"
