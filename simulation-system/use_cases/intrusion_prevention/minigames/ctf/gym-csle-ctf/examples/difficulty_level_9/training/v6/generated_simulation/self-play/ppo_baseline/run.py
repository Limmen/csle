...
def default_config() -> ClientConfig:
    ...
    eval_env_name = "csle-ctf-level-9-emulation-v5"
    ...
    client_config = ClientConfig(env_name=env_name, defender_agent_config=defender_agent_config,
