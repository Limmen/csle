...
def default_config() -> ClientConfig:
    ...
    """
    agent_config = AgentConfig(gamma=1, alpha=0.001, epsilon=1, render=False, eval_sleep=0.0,
                               ...
                               running_avg=50, n_quick_eval_iter=5, n_deterministic_eval_iter=0,
                               log_regret=True, snort_baseline_simulate=False, quick_eval_freq=1,
                               eval_deterministic=False
                               )
    env_name = "csle-ctf-level-9-generated-sim-v1"
    #eval_env_name = "csle-ctf-level-9-emulation-v1"
    eval_env_name = "csle-ctf-level-9-generated-sim-v1"
    ...
    # eval_emulation_config.save_dynamics_model_dir = "/home/kim/storage/workspace/csle/simulation-system/minigames/" \
    ...
    #                                                 "network_intrusion/ctf/gym-csle-ctf/examples/difficulty_level_4/" \
    ...
    # eval_emulation_config.save_dynamics_model_dir = "/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion" \
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_9 v1 gensim"
