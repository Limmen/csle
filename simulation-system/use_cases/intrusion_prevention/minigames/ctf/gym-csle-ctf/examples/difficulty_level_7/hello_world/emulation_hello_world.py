...
def test_all():
    #test_env("csle-ctf-level-7-emulation-v1", num_steps=1000000000)
    #test_env("csle-ctf-level-7-emulation-v2", num_steps=1000000000)
    #test_env("csle-ctf-level-7-emulation-v3", num_steps=1000000000)
    test_env("csle-ctf-level-7-emulation-v1", num_steps=1000000000)
