...
class Simulator:
    ...
    def __init__(self, env: CSLECTFEnv, config: SimulationConfig, attacker: PPOAttackerBotAgent):
        """
    ...
    def simulate(self) -> ExperimentResult:
        ...
        if self.config.video:
            ...
            self.env = CSLECTFMonitor(self.env, self.config.video_dir + "/" + time_str, force=True,
