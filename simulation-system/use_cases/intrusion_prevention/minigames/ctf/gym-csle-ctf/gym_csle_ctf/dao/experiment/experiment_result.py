...
import csv
from csle_common.dao.experiment.base_experiment_result import BaseExperimentResult


class ExperimentResult(BaseExperimentResult):
    """
    DTO with experiment result from an experiment in the csle-ctf-envs
    """
    ...
    def to_csv(self, file_path : str) -> None:
        ...
        metric_labels = ["attacker_avg_episode_rewards", "defender_avg_episode_rewards", "avg_episode_steps",
                   ...
                   "attacker_avg_episode_loss", "defender_avg_episode_loss",
                   "lr_list", "avg_episode_flags",
                   "avg_episode_flags_percentage", "attacker_eval_avg_episode_rewards",
                   "defender_eval_avg_episode_rewards",
                   "eval_avg_episode_steps",
                   "eval_avg_episode_flags", "eval_avg_episode_flags_percentage",
                   "attacker_eval_2_avg_episode_rewards", "defender_eval_2_avg_episode_rewards",
                   "eval_2_avg_episode_steps",
                   "eval_2_avg_episode_flags", "eval_2_avg_episode_flags_percentage", "rollout_times",
                   "env_response_times", "action_pred_times", "grad_comp_times", "weight_update_times",
                   "attacker_avg_regret", "defender_avg_regret",
                   ...
                   "eval_2_caught_frac", "eval_2_early_stopping_frac",
                   "eval_2_intrusion_frac",
                   ...
                   "eval_2_snort_severe_baseline_caught_attacker", "eval_2_snort_warning_baseline_caught_attacker",
                   ...
                   "eval_2_snort_severe_baseline_early_stopping",
                   "eval_2_snort_warning_baseline_early_stopping",
                   ...
                   "avg_uncaught_intrusion_steps", "eval_avg_uncaught_intrusion_steps",
                   "eval_2_avg_uncaught_intrusion_steps", "avg_optimal_defender_reward",
                   "eval_avg_optimal_defender_reward", "eval_2_avg_optimal_defender_reward",
                   ...
                   "avg_snort_severe_baseline_first_stop_step", "avg_snort_warning_baseline_first_stop_step",
                   "avg_snort_critical_baseline_first_stop_step", "avg_var_log_baseline_first_stop_step",
                   "avg_step_baseline_first_stop_step",
                   "avg_snort_severe_baseline_second_stop_step", "avg_snort_warning_baseline_second_stop_step",
                   "avg_snort_critical_baseline_second_stop_step", "avg_var_log_baseline_second_stop_step",
                   "avg_step_baseline_second_stop_step",
                   "avg_snort_severe_baseline_third_stop_step", "avg_snort_warning_baseline_third_stop_step",
                   "avg_snort_critical_baseline_third_stop_step", "avg_var_log_baseline_third_stop_step",
                   "avg_step_baseline_third_stop_step",
                   "avg_snort_severe_baseline_fourth_stop_step", "avg_snort_warning_baseline_fourth_stop_step",
                   "avg_snort_critical_baseline_fourth_stop_step", "avg_var_log_baseline_fourth_stop_step",
                   "avg_step_baseline_fourth_stop_step",
                   "avg_snort_severe_baseline_stops_remaining", "avg_snort_warning_baseline_stops_remaining",
                   "avg_snort_critical_baseline_stops_remaining", "avg_var_log_baseline_stops_remaining",
                   "avg_step_baseline_stops_remaining",
                   "eval_avg_snort_severe_baseline_first_stop_step", "eval_avg_snort_warning_baseline_first_stop_step",
                   "eval_avg_snort_critical_baseline_first_stop_step", "eval_avg_var_log_baseline_first_stop_step",
                   "eval_avg_step_baseline_first_stop_step",
                   "eval_avg_snort_severe_baseline_second_stop_step", "eval_avg_snort_warning_baseline_second_stop_step",
                   "eval_avg_snort_critical_baseline_second_stop_step", "eval_avg_var_log_baseline_second_stop_step",
                   "eval_avg_step_baseline_second_stop_step",
                   "eval_avg_snort_severe_baseline_third_stop_step", "eval_avg_snort_warning_baseline_third_stop_step",
                   "eval_avg_snort_critical_baseline_third_stop_step", "eval_avg_var_log_baseline_third_stop_step",
                   "eval_avg_step_baseline_third_stop_step",
                   "eval_avg_snort_severe_baseline_fourth_stop_step", "eval_avg_snort_warning_baseline_fourth_stop_step",
                   "eval_avg_snort_critical_baseline_fourth_stop_step", "eval_avg_var_log_baseline_fourth_stop_step",
                   "eval_avg_step_baseline_fourth_stop_step",
                   "eval_avg_snort_severe_baseline_stops_remaining", "eval_avg_snort_warning_baseline_stops_remaining",
                   "eval_avg_snort_critical_baseline_stops_remaining", "eval_avg_var_log_baseline_stops_remaining",
                   "eval_avg_step_baseline_stops_remaining",
                   "eval_2_avg_snort_severe_baseline_first_stop_step", "eval_2_avg_snort_warning_baseline_first_stop_step",
                   "eval_2_avg_snort_critical_baseline_first_stop_step", "eval_2_avg_var_log_baseline_first_stop_step",
                   "eval_2_avg_step_baseline_first_stop_step",
                   "eval_2_avg_snort_severe_baseline_second_stop_step", "eval_2_avg_snort_warning_baseline_second_stop_step",
                   "eval_2_avg_snort_critical_baseline_second_stop_step", "eval_2_avg_var_log_baseline_second_stop_step",
                   "eval_2_avg_step_baseline_second_stop_step",
                   "eval_2_avg_snort_severe_baseline_third_stop_step", "eval_2_avg_snort_warning_baseline_third_stop_step",
                   "eval_2_avg_snort_critical_baseline_third_stop_step", "eval_2_avg_var_log_baseline_third_stop_step",
                   "eval_2_avg_step_baseline_third_stop_step",
                   "eval_2_avg_snort_severe_baseline_fourth_stop_step", "eval_2_avg_snort_warning_baseline_fourth_stop_step",
                   "eval_2_avg_snort_critical_baseline_fourth_stop_step", "eval_2_avg_var_log_baseline_fourth_stop_step",
                   "eval_2_avg_step_baseline_fourth_stop_step",
                   "eval_2_avg_snort_severe_baseline_stops_remaining", "eval_2_avg_snort_warning_baseline_stops_remaining",
                   "eval_2_avg_snort_critical_baseline_stops_remaining", "eval_2_avg_var_log_baseline_stops_remaining",
