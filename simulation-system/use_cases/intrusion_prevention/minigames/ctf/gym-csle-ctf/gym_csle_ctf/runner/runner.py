"""
Generic runner for running experiments with csle environments
"""
...
from csle_common.agents.policy_gradient.reinforce.reinforce_agent import ReinforceAgent
from csle_common.agents.train_agent import TrainAgent
from csle_common.agents.policy_gradient.ppo_baseline.ppo_baseline_agent import PPOBaselineAgent
from csle_common.agents.bots.ppo_attacker_bot_agent import PPOAttackerBotAgent
from csle_common.dao.experiment.runner_mode import RunnerMode
from csle_common.agents.dqn.dqn_baseline_agent import DQNBaselineAgent
from csle_common.agents.policy_gradient.a2c_baseline.a2c_baseline_agent import A2CBaselineAgent
from csle_common.agents.td3.td3_baseline_agent import TD3BaselineAgent
from csle_common.agents.ddpg.ddpg_baseline_agent import DDPGBaselineAgent
from csle_common.agents.openai_baselines.common.env_util import make_vec_env
from csle_common.agents.openai_baselines.common.vec_env.dummy_vec_env import DummyVecEnv
from csle_common.agents.openai_baselines.common.vec_env.subproc_vec_env import SubprocVecEnv
...
from gym_csle_ctf.util.experiments_util.simulator import Simulator
...
from gym_csle_ctf.envs_model.util.eval_util import EvalUtil
    ...
    def train(config: ClientConfig) -> Tuple[ExperimentResult, ExperimentResult]:
        ...
        if config.agent_type == AgentType.REINFORCE.value:
            ...
            agent = PPOBaselineAgent(env,
                                     attacker_agent_config=config.attacker_agent_config,
                                     defender_agent_config=config.defender_agent_config,
                                     train_agent_dto=TrainAgentLogDTO(),
