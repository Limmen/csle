        ...
        while True:
            ...
            if msg is not None:
                if msg.error():
                    ...
                    self.s.defender_obs_state.ids_alert_counters = AlertCounters.from_kafka_record(
                        record=msg.value().decode())
                    print(self.s.defender_obs_state.ids_alert_counters)
