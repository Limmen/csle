...
def docker_stats2():
    ...
    client_1 = docker.DockerClient(base_url=constants.DOCKER.SSH_PREFIX + "172.31.212.92")
    client2 = docker.APIClient(base_url=constants.DOCKER.SSH_PREFIX + "172.31.212.92")
