...
def test_env(env_name : str, num_steps : int):
    ...
    #                                server_username="kim")
    emulation_config = EmulationConfig(agent_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}10.191", agent_username="agent", agent_pw="agent",
...
def test_all():
    #test_env("csle-ctf-level-10-emulation-v1", num_steps=1000000000)
    #test_env("csle-ctf-level-10-emulation-v2", num_steps=1000000000)
    #test_env("csle-ctf-level-10-emulation-v3", num_steps=1000000000)
    test_env("csle-ctf-level-10-emulation-v1", num_steps=1000000000)
