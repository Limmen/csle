...
def test_all():
    #test_env("csle-ctf-level-2-emulation-v2", num_steps=1000000000)
    #test_env("csle-ctf-level-2-emulation-v3", num_steps=1000000000)
    #test_env("csle-ctf-level-2-emulation-v4", num_steps=1000000000)
    test_env("csle-ctf-level-2-emulation-v4", num_steps=1000000000)
    #test_env("csle-ctf-level-2-generated-sim-v1", num_steps=1000000000)
    #test_env("csle-ctf-level-2-emulation-base-v1", num_steps=1000000000)
