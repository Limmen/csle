...
def default_config() -> ClientConfig:
    ...
    env_name = "csle-ctf-level-2-generated-sim-v1"
    eval_env_name = "csle-ctf-level-2-emulation-v1"

    # env_name = "csle-ctf-level-2-generated-sim-costs-v1"
    # eval_env_name = "csle-ctf-level-2-emulation-costs-v1"
    ...
    eval_emulation_config = EmulationConfig(agent_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}2.191", agent_username="agent", agent_pw="agent",
                                          server_connection=False, port_forward_next_port=3400)
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_1 v1 generated simulation"
