...
def default_config() -> ClientConfig:
    ...
    env_name = "csle-ctf-level-2-sim-v1"
    eval_env_name = "csle-ctf-level-2-emulation-v1"

    # eval_emulation_config = emulationConfig(server_ip="172.31.212.91", agent_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}21.191",
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_2 v1 simulation"
