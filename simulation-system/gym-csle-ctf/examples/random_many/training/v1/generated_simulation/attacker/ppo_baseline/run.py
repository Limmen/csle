...
def default_config() -> ClientConfig:
    ...
    # containers_configs = containers_configs[0:2]
    # flags_configs = flags_configs[0:2]
    ...
    emulation_configs = [
        EmulationConfig(agent_ip=containers_configs[i].agent_ip, agent_username="agent", agent_pw="agent",
                      ...
                      warmup=True, warmup_iterations=200,
                      save_dynamics_model_dir="/home/kim/storage/workspace/csle/simulation-system/minigames/network_intrusion/ctf/gym-csle-ctf/examples/random_many/hello_world/",
                      save_dynamics_model_file="defender_dynamics_model_" + str(i) + ".json",
                      save_netconf_file="network_conf_" + str(i) + ".pickle",
                      save_trajectories_file="taus_" + str(i) + ".json",
                      skip_exploration=True
    ...
    client_config = ClientConfig(env_name=env_name, attacker_agent_config=agent_config,
                                 ...
                                 run_many=True, random_seeds=[81810, 771999, 299],
                                 random_seed=71245, emulation_configs=emulation_configs, mode=RunnerMode.TRAIN_ATTACKER.value,
