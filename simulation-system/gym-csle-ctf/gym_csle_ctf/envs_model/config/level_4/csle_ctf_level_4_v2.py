...
class CSLECTFLevel4V2:
    """
    V2 configuration of level 4 of the CSLECTF environment.
    """
    ...
    def env_config(network_conf : NetworkConfig,
        ...
        env_config = CSLEEnvConfig(network_conf=network_conf, attacker_action_conf=attacker_action_conf,
                                   ...
                                   attacker_num_sh_obs=3, num_nodes = CSLECTFLevel4Base.num_nodes(), render_config=render_conf, env_mode=EnvMode.SIMULATION,
