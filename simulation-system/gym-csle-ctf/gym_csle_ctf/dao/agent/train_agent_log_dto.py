...
class TrainAgentLogDTO(BaseTrainAgentLogDTO):
    ...
    def eval_update_env_specific_metrics(self, env_config : CSLEEnvConfig, infos : dict, i: int) -> int:
        """
    ...
    def eval_2_update_env_specific_metrics(self, env_config : CSLEEnvConfig, infos : dict, i : int) -> None:
        """
    ...
    def eval_update(self, attacker_episode_reward, defender_episode_reward, _info: dict, episode_length: int,
                    env_conf: CSLEEnvConfig, i: int) -> None:
        """
    ...
    def get_avg_attacker_dto(self, attacker_agent_config: AgentConfig, env: CSLECTFEnv, env_2: CSLECTFEnv, eval : bool):
        """
    ...
    def get_avg_defender_dto(self, defender_agent_config: AgentConfig, env: CSLECTFEnv, env_2: CSLECTFEnv, eval : bool,
