...
# -------- Version 1 ------------
class CSLECTFLevel9GeneratedSim1Env(CSLECTFEnv):
    """
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            network_conf = CSLECTFLevel9Base.network_conf(generate=True)
            ...
            defender_action_conf = CSLECTFLevel9V1.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask())
        ...
        super(CSLECTFLevel9GeneratedSim1Env, self).__init__(env_config=env_config)


# -------- Version 1, costs ------------
class CSLECTFLevel9GeneratedSimWithCosts1Env(CSLECTFEnv):
    """
    Generated Simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        ...
        super(CSLECTFLevel9GeneratedSimWithCosts1Env, self).__init__(env_config=env_config)


# -------- Version 2 ------------

class CSLECTFLevel9GeneratedSim2Env(CSLECTFEnv):
    """
    Generated simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = CSLECTFLevel9V2.attacker_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask(),
                                                                hacker_ip=CSLECTFLevel9Base.hacker_ip())
            defender_action_conf = CSLECTFLevel9V2.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                         subnet_mask=CSLECTFLevel9Base.subnet_mask())
            ...
            env_config.attacker_max_exploration_steps = 100
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSim2Env, self).__init__(env_config=env_config)

# -------- Version 2, costs ------------


class CSLECTFLevel9GeneratedSimWithCosts2Env(CSLECTFEnv):
    """
    Generated simulation.
    Slightly more set of actions than V1. Does not take action costs into account.
    """
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            env_config.attacker_max_exploration_steps = 100
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSimWithCosts2Env, self).__init__(env_config=env_config)

# -------- Version 3 ------------

class CSLECTFLevel9GeneratedSim3Env(CSLECTFEnv):
    """
    Generated simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = CSLECTFLevel9V3.attacker_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask(),
                                                                hacker_ip=CSLECTFLevel9Base.hacker_ip())
            defender_action_conf = CSLECTFLevel9V3.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                         subnet_mask=CSLECTFLevel9Base.subnet_mask())
            ...
            env_config.attacker_max_exploration_steps = 100
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSim3Env, self).__init__(env_config=env_config)

# -------- Version 3, costs ------------

class CSLECTFLevel9GeneratedSimWithCosts3Env(CSLECTFEnv):
    """
    Generated simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            env_config.attacker_max_exploration_steps = 100
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSimWithCosts3Env, self).__init__(env_config=env_config)


# -------- Version 4 ------------

class CSLECTFLevel9GeneratedSim4Env(CSLECTFEnv):
    """
    Generated simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = CSLECTFLevel9V4.attacker_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask(),
                                                                hacker_ip=CSLECTFLevel9Base.hacker_ip())
            defender_action_conf = CSLECTFLevel9V4.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                         subnet_mask=CSLECTFLevel9Base.subnet_mask())
            ...
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSim4Env, self).__init__(env_config=env_config)

# -------- Version 4 ------------


class CSLECTFLevel9GeneratedSimWithCosts4Env(CSLECTFEnv):
    """
    Generated simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            env_config.attacker_max_exploration_steps = 100
            env_config.attacker_max_exploration_trajectories = 10
        super(CSLECTFLevel9GeneratedSimWithCosts4Env, self).__init__(env_config=env_config)



# -------- Version 5 ------------

class CSLECTFLevel9GeneratedSim5Env(CSLECTFEnv):
    """
    Generated Simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = CSLECTFLevel9V5.attacker_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask(),
                                                                hacker_ip=CSLECTFLevel9Base.hacker_ip())
            defender_action_conf = CSLECTFLevel9V5.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask())
...
class CSLECTFLevel9GeneratedSim6Env(CSLECTFEnv):
    """
    Generated Simulation.
    ...
    def __init__(self, env_config: CSLEEnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = CSLECTFLevel9V6.attacker_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask(),
                                                                hacker_ip=CSLECTFLevel9Base.hacker_ip())
            defender_action_conf = CSLECTFLevel9V6.defender_actions_conf(num_nodes=CSLECTFLevel9Base.num_nodes(),
                                                                subnet_mask=CSLECTFLevel9Base.subnet_mask())
            ...
            env_config.use_attacker_action_stats_to_update_defender_state = False
            env_config.snort_baseline_simulate = True
            env_config.randomize_defender_starting_state = False
