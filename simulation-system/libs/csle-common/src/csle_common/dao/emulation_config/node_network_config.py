...
class NodeNetworkConfig(JSONSerializable):
    ...
    def __init__(self, interface: str = constants.NETWORKING.ETH0,
                 ...
                 packet_delay_distribution: PacketDelayDistributionType = PacketDelayDistributionType.PARETO.value,
                 packet_loss_type: PacketLossType = PacketLossType.GEMODEL.value,
