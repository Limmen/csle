...
class C51Policy(Policy):
    ...
    def __init__(self, model: Union[None, DQN, QNetwork], simulation_name: str, save_path: str,
        ...
        """
        super(C51Policy, self).__init__(agent_type=AgentType.C51, player_type=player_type)
        self.model = model
        self.id = -1
        ...
        self.avg_R = avg_R
        self.policy_type = PolicyType.C51
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "C51Policy":
        """
        ...
        """
        obj = C51Policy(model=None, simulation_name=d["simulation_name"], save_path=d["save_path"],
    ...
    def from_json_file(json_file_path: str) -> "DQNPolicy":
        ...
        with io.open(json_file_path, 'r') as f:
            json_str = f.read()
        return C51Policy.from_dict(json.loads(json_str))

    def copy(self) -> "C51Policy":
        """
