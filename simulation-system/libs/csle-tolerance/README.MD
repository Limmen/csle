# Tolerance: (T)w(o)-(l)ev(e)l (r)ecovery (a)nd respo(n)se (c)ontrol with f(e)edback.
...
```bash
# install from pip
pip install csle-tolerance==<version>
# local install from source
$ pip install -e csle-tolerance
# or (equivalently):
make install
# force upgrade deps
$ pip install -e csle-tolerance --upgrade
# git clone and install from source
git clone https://github.com/Kim-Hammar/csle
cd csle/simulation-system/libs/csle-tolerance
pip3 install -e .
...
The latest documentation is available at [https://kim-hammar.github.io/csle//docs/csle-tolerance](https://kim-hammar.github.io/csle//docs/csle-tolerance)
...
```bash
cd docs
sphinx-apidoc -f -o source/ ../src/csle_tolerance/
make html
```
...
```bash
cp -r build/html ../../../../docs/_docs/csle-tolerance
```
