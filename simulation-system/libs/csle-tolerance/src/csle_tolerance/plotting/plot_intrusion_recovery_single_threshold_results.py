...
def plot_bo_results_and_gp(bo_results: BOResults, file_name: str, fontsize: int = 18, markevery: int = 1) -> None:
    """
    ...
    ax[1].plot(list(range(len(bo_results.X_best[:, 0]))), bo_results.Y_best[:, 0],
               ...
               ls='-', color="#599ad3", marker="s", markevery=markevery, markersize=7)
