...
class IntrusionRecoveryPomdpUtil:
    ...
    @staticmethod
    def manual_play(config: IntrusionRecoveryPomdpConfig) -> None:
        """
        ...
        while True:
            ...
            if raw_input == "help":
                ...
                c = config.cost_tensor[a][s]
                print(f"s: {s}, a: {a}, c: {c}")
                s = GeneralUtil.sample_next_state(transition_tensor=config.transition_tensor, s=s, a=a,
                                                  states=config.states)
                o = IntrusionRecoveryPomdpUtil.sample_next_observation(observation_tensor=config.observation_tensor, s_prime=s,
                                                                       observations=config.observations)
                b = IntrusionRecoveryPomdpUtil.next_belief(o=o, a=a, b=b, states=config.states,
                                                           observations=config.observations,
