...
class TestResourcesPostgresqlSuite(object):
    ...
    @pytest.fixture
    def node_status_postgresql_running(self, mocker, example_node_status):
        """
    ...
    @pytest.fixture
    def node_status_postgresql_not_running(self, mocker, example_node_status):
        """
    ...
    def test_postgresql_get(self, flask_app, mocker, logged_in_as_admin, logged_in, not_logged_in, config,
                            node_status_postgresql_running, node_status_postgresql_not_running, start, stop,
                            example_config) -> None:
        """
