...
class TestResourcesPostgresqlSuite(object):
    ...
    def config(self, mocker):
        ...
        """
        def get_config(id):
            config = TestResourcesPostgresqlSuite.example_config()
            return config
    ...
    @pytest.fixture
    def node_status_postgresql_running(self, mocker):
        """
        ...
        def get_node_status(ip: str, port: int) -> NodeStatusDTO:
            node_status = TestResourcesPostgresqlSuite.example_node_status()
    ...
    @pytest.fixture
    def node_status_postgresql_not_running(self, mocker):
        """
    ...
    def test_postgresql_get(self, flask_app, mocker, logged_in_as_admin, logged_in, not_logged_in, config,
                            node_status_postgresql_running, node_status_postgresql_not_running, start, stop) -> None:
        """
        ...
        mocker.patch(
            "csle_cluster.cluster_manager.cluster_controller.ClusterController.start_postgresql",
            side_effect=start,
        )
        mocker.patch(
            "csle_cluster.cluster_manager.cluster_controller.ClusterController.stop_postgresql",
            side_effect=stop,
        )
    ...
    def test_postgresql_post(self, flask_app, mocker, logged_in_as_admin, logged_in, not_logged_in, config,
                             node_status_postgresql_running, node_status_postgresql_not_running, start, stop) -> None:
        """
