...
class TestResourcesNodeExporterSuite(object):
    ...
    @pytest.fixture
    def node_status_cadvisor_running(self, mocker):
        """
    ...
    @pytest.fixture
    def node_status_cadvisor_not_running(self, mocker):
        """
    ...
    def test_cadvisor(self, flask_app, mocker, logged_in_as_admin, logged_in, not_logged_in, config,
                      node_status_cadvisor_running, node_status_cadvisor_not_running, start, stop) -> None:
        """
        Tests the /cadvisor url
