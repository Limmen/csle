...
@config_bp.route(
    f"{constants.COMMANDS.SLASH_DELIM}{api_constants.MGMT_WEBAPP.REGISTRATION_ALLOWED_SUBRESOURCE}",
...
def registration_allowed():
    ...
    if (
        constants.CONFIG_FILE.PARSED_CONFIG is not None
        and constants.CONFIG_FILE.PARSED_CONFIG.allow_registration
    ):
        allow_registration = True
    response_dict = {}
    response_dict[
        api_constants.MGMT_WEBAPP.REGISTRATION_ALLOWED_PROPERTY
    ] = allow_registration
