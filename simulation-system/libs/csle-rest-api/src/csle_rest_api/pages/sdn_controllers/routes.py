...
def get_sdn_controllers_page_bp(static_folder: str) -> Blueprint:
    ...
    sdn_controllers_page_bp = Blueprint(
        api_constants.MGMT_WEBAPP.SDN_CONTROLLERS_PAGE_RESOURCE,
        __name__,
    ...
    def sdn_controllers_page():
        ...
        """
        return sdn_controllers_page_bp.send_static_file(
