...
def get_host_terminal_page_bp(static_folder: str) -> Blueprint:
    """
    Creates a blueprint "sub application" of the main REST app that represents the host-terminal page

    :param static_folder: the folder with the static resources
    :return: the created blueprint
    """
    # Creates a blueprint "sub application" of the main REST app
    host_terminal_page_bp = Blueprint(
        api_constants.MGMT_WEBAPP.HOST_TERMINAL_PAGE_RESOURCE, __name__,
