...
def get_traces_page_bp(static_folder: str) -> Blueprint:
    """
    Creates a blueprint "sub application" of the main REST app that represents the traces page

    :param static_folder: the folder with the static resources
    :return: the created blueprint
    """
    # Creates a blueprint "sub application" of the main REST app
    traces_page_bp = Blueprint(
        api_constants.MGMT_WEBAPP.TRACES_PAGE_RESOURCE,
        __name__,
    ...
    def traces_page():
        ...
        """
        return traces_page_bp.send_static_file(
