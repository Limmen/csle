...
def get_register_page_bp(static_folder: str) -> Blueprint:
    """
    Creates a blueprint "sub application" of the main REST app that represents the register page

    :param static_folder: the folder with the static resources
    :return: the created blueprint
    """
    # Creates a blueprint "sub application" of the main REST app
    register_page_bp = Blueprint(
        api_constants.MGMT_WEBAPP.REGISTER_PAGE_RESOURCE,
        __name__,
    ...
    def register_page():
        ...
        """
        return register_page_bp.send_static_file(
