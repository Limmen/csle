...
def get_system_admin_page_bp(static_folder: str) -> Blueprint:
    ...
    system_admin_page_bp = Blueprint(
        api_constants.MGMT_WEBAPP.SYSTEM_ADMIN_PAGE_RESOURCE, __name__,
    ...
    def system_admin_page() -> Tuple[Response, int]:
        """
        :return: static resources for the /system-admin-page url
        """
        return (system_admin_page_bp.send_static_file(api_constants.MGMT_WEBAPP.STATIC_RESOURCE_INDEX),
