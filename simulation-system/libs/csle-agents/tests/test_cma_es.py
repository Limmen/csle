...
class TestCMAESSuite:
    """
    Test suite for the CMA-ES
    """
    ...
    def experiment_config(self) -> ExperimentConfig:
        ...
        experiment_config = ExperimentConfig(
            output_dir=f"{constants.LOGGING.DEFAULT_LOG_DIR}cma_es_test", title="CMA-ES test",
            random_seeds=[399],
            ...
            hparams={
                ...
                agents_constants.CMA_ES_OPTIMIZATION.THETA1: HParam(
                    value=[-3, 3], name=agents_constants.CMA_ES_OPTIMIZATION.THETA1,
    ...
    def test_create_agent(self, mocker: pytest_mock.MockFixture, experiment_config: ExperimentConfig) -> None:
        """
        Tests creation of the CMAESAgent
    ...
    def test_run_agent(self, mocker: pytest_mock.MockFixture, experiment_config: ExperimentConfig,
        ...
        mocker.patch('csle_common.metastore.metastore_facade.MetastoreFacade.save_multi_threshold_stopping_policy',
                     return_value=True)
        agent = CMAESAgent(simulation_env_config=simulation_env_config,
                           emulation_env_config=emulation_env_config,
                           experiment_config=experiment_config)
        ...
        for seed in experiment_config.random_seeds:
            ...
            assert agents_constants.CMA_ES_OPTIMIZATION.THETAS in experiment_execution.result.all_metrics[seed]
            ...
            assert agents_constants.CMA_ES_OPTIMIZATION.THRESHOLDS in experiment_execution.result.all_metrics[seed]
