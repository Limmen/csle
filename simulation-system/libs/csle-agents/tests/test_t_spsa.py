...
class TestTSPSASuite(object):
    """
    Test suite for the TSPSAAgent
    """
    ...
    def experiment_config(self) -> ExperimentConfig:
        ...
        experiment_config = ExperimentConfig(
            ...
            log_every=1,
            hparams={
                constants.T_SPSA.N: HParam(value=2, name=constants.T_SPSA.N,
                ...
                constants.T_SPSA.EPSILON: HParam(
                    ...
                    descr="scalar coefficient for determining gradient step sizes in T-SPSA"),
                constants.T_SPSA.L: HParam(value=1, name="L", descr="the number of stop actions"),
    ...
    def test_create_agent(self, mocker, experiment_config: ExperimentConfig) -> None:
        """
        Tests creation of the TSPSAAgent
        ...
        TSPSAAgent(emulation_env_config=emulation_env_config, simulation_env_config=simulation_env_config,
    ...
    def test_run_agent(self, mocker, experiment_config: ExperimentConfig,
        ...
        agent = TSPSAAgent(emulation_env_config=emulation_env_config,
                           ...
                           experiment_config=experiment_config)
        pytest.logger.info("Starting training of the TSPSA Agent")
        ...
        for seed in experiment_config.random_seeds:
            ...
            assert constants.T_SPSA.THETAS in experiment_execution.result.all_metrics[seed]
            ...
            assert constants.T_SPSA.THRESHOLDS in experiment_execution.result.all_metrics[seed]
