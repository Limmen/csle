...
class TestDifferentialEvolutionSuite(object):
    """
    ...
    def experiment_config(self) -> ExperimentConfig:
        ...
        experiment_config = ExperimentConfig(
            ...
            hparams={
                ...
                agents_constants.DIFFERENTIAL_EVOLUTION.L: HParam(value=1, name="L",
    ...
    def test_create_agent(self, mocker, experiment_config: ExperimentConfig) -> None:
        """
        Tests creation of the DifferentialEvolutionAgent
    ...
    def test_run_agent(self, mocker, experiment_config: ExperimentConfig,
        ...
        for seed in experiment_config.random_seeds:
            ...
            assert agents_constants.DIFFERENTIAL_EVOLUTION.THETAS in experiment_execution.result.all_metrics[seed]
            ...
            assert agents_constants.DIFFERENTIAL_EVOLUTION.THRESHOLDS in experiment_execution.result.all_metrics[seed]
