...
class TestNelderMeadSuite:
    """
    Test suite for the NelderMeadAgent
    """
    ...
    def experiment_config(self) -> ExperimentConfig:
        ...
        """
        experiment_config = ExperimentConfig(output_dir=f"{constants.LOGGING.DEFAULT_LOG_DIR}NELDER_MEAD_test",
                                             title="Nelder-Mead test", random_seeds=[399],
                                             ...
                                             hparams={
                                                 ...
                                                 agents_constants.NELDER_MEAD.IMPROVE_BREAK: HParam(
                                                 ...
                                                 agents_constants.NELDER_MEAD.STEP: HParam(
                                                     ...
                                                     descr="the step in which we modify/pertube each inital guess"
                                                     " in the simplex"),
                                                 agents_constants.NELDER_MEAD.IMPROVE_THRESHOLD: HParam(
                                                     value=10e-6, name=agents_constants.NELDER_MEAD.IMPROVE_THRESHOLD,
                                                     descr="the threshold whose subtraction of "
                                                     "previous best is compared to the current best"),
                                                 agents_constants.COMMON.EVAL_BATCH_SIZE: HParam(
                                                     value=100, name=agents_constants.COMMON.EVAL_BATCH_SIZE,
                                                     descr="number of iterations to evaluate theta"),
                                                 agents_constants.NELDER_MEAD.THETA1: HParam(
                                                     value=[-3, -3, -3], name=agents_constants.NELDER_MEAD.THETA1,
                                                     descr="initial thresholds"),
                                                 agents_constants.COMMON.SAVE_EVERY: HParam(
                                                     value=1000, name=agents_constants.COMMON.SAVE_EVERY,
                                                 ...
                                                 agents_constants.COMMON.MAX_ENV_STEPS: HParam(
                                                     ...
                                                     "(for envs with infinite horizon generally)"),
                                                 agents_constants.COMMON.RUNNING_AVERAGE: HParam(
                                                     value=100, name=agents_constants.COMMON.RUNNING_AVERAGE,
                                                     descr="the number of samples to include when computing the "
                                                     "running avg"),
                                                 agents_constants.COMMON.GAMMA: HParam(value=0.99,
                                                                                       name=agents_constants.COMMON.
                                                                                       GAMMA,
                                                                                       descr="the discount factor"),
                                                 agents_constants.NELDER_MEAD.POLICY_TYPE: HParam(
                                                     value=PolicyType.MULTI_THRESHOLD, name=agents_constants.
                                                     NELDER_MEAD.POLICY_TYPE,
                                                     descr="policy type for the execution"),
                                                 agents_constants.NELDER_MEAD.OBJECTIVE_TYPE: HParam(
                                                     value=ObjectiveType.MAX, name=agents_constants.NELDER_MEAD.
                                                     OBJECTIVE_TYPE, descr="Objective type")},
    ...
    def test_create_agent(self, mocker: pytest_mock.MockFixture, experiment_config: ExperimentConfig) -> None:
        ...
        NelderMeadAgent(emulation_env_config=emulation_env_config, simulation_env_config=simulation_env_config,
