...
class AptGameEnv(BaseEnv):
    ...
    @staticmethod
    def emulation_evaluation(env: "AptGameEnv", n_episodes: int, intrusion_seq: List[EmulationAttackerAction],
        ...
        for i in range(n_episodes):
            ...
            while not done:
                ...
                b = AptGameUtil.next_belief(o=emulation_o, a1=a1, b=b, pi2=a2, config=env.config,
                                                 l=env.state.l, a2=a2)
                d_obs[1] = b[1]
                a_obs[1] = b[1]
                logger.debug(f"b:{b}")
