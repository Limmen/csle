...
class BaseCSLEEnv(gym.Env, ABC):
    ...
    @staticmethod
    @abstractmethod
    def is_defense_action_legal(defense_action_id: int, env_config: BaseCSLEEnvConfig, env_state: BaseEnvState) -> bool:
        """
    ...
    @staticmethod
    @abstractmethod
    def is_attack_action_legal(attack_action_id: int, env_config: BaseCSLEEnvConfig, env_state: BaseEnvState,
