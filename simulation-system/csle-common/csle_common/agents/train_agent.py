...
class TrainAgent(ABC):
    ...
    def __init__(self, env, attacker_config: AgentConfig,
        ...
        if env.attacker_action_space is not None:
            env.attacker_action_space.seed(self.attacker_config.random_seed)
        if env.defender_action_space is not None:
            env.defender_action_space.seed(self.attacker_config.random_seed)
