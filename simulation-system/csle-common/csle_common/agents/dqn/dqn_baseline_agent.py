"""
An agent for the csle env that uses the DQN algorithm from OpenAI stable baselines
"""
import time
import math
...
from csle_common.agents.dqn.impl.dqn import DQN
from csle_common.agents.util.agent_util import AgentUtil


class DQNBaselineAgent(TrainAgent):
    """
    An agent for the csle env that uses the TD3 Policy Gradient algorithm from OpenAI stable baselines
    """
