...
import numpy as np
from csle_common.agents.openai_baselines.common.policies import BasePolicy, register_policy
from csle_common.agents.openai_baselines.common.torch_layers import BaseFeaturesExtractor, FlattenExtractor, \
...
class QNetwork(BasePolicy):
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = True, env_state: BaseEnvState = None,
        ...
        legal_actions = list(filter(lambda action: BaseCSLEEnv.is_attack_action_legal(
