...
from csle_common.agents.openai_baselines.common.utils import get_linear_fn, polyak_update
from csle_common.agents.dqn.impl.policies import DQNPolicy
...
class DQN(OffPolicyAlgorithm):
    ...
    def predict(
        ...
        env_config : CSLEEnvConfig = None,
        env_configs: List[CSLEEnvConfig] = None,
        ...
        if not deterministic and np.random.rand() < self.exploration_rate:
            ...
            legal_actions = list(filter(lambda action: CSLECTFEnv.is_attack_action_legal(
