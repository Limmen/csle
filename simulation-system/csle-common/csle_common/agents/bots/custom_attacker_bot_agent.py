"""
A general bot attack agent for the csle environment that acts according to a custom pre-defined policy
"""
...
class CustomAttackerBotAgent:
    ...
    def __init__(self, env_config: BaseCSLEEnvConfig, env, strategy: List[int], random_start : bool = False,
