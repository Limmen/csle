...
from csle_common.agents.openai_baselines.common.torch_layers import BaseFeaturesExtractor, \
    FlattenExtractor, MlpExtractor, NatureCNN, create_mlp
from csle_common.agents.config.agent_config import AgentConfig
from csle_common.agents.openai_baselines.common.distributions import (Distribution, make_proba_distribution)
...
class BasePolicy(BaseModel):
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = False, env_state: BaseEnvState = None,
                 env_config: BaseCSLEEnvConfig = None, m_index : int = None) -> th.Tensor:
        """
    ...
    def predict(
        ...
        env_configs: BaseCSLEEnvConfig = None,
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = False, env_state: BaseEnvState = None,
                 env_config: BaseCSLEEnvConfig = None, m_index : int = None, env = None, infos = None,
                 env_configs: List[BaseCSLEEnvConfig] = None, env_idx: int = None, mask_actions: bool = True,
