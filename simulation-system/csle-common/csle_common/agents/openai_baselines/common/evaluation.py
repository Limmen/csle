...
def quick_evaluate_policy(attacker_model: "BaseAlgorithm", defender_model: "BaseAlgorithm",
                          ...
                          env_config: BaseCSLEEnvConfig = None, env_configs : List[BaseCSLEEnvConfig] = None,
                          eval_env_config: BaseCSLEEnvConfig = None, eval_envs_configs: List[BaseCSLEEnvConfig] = None,
                          train_mode: TrainMode = TrainMode.TRAIN_ATTACKER,
                          train_dto : BaseTrainAgentLogDTO = None
                          ):
    """
