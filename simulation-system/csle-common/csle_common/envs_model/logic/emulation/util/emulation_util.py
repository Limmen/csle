...
class EmulationUtil:
    ...
    @staticmethod
    def log_measured_action_time(total_time, action: AttackerAction,
                                 emulation_env_agent_config: EmulationEnvAgentConfig) -> None:
        """
        ...
        emulation_env_agent_config.emulation_config.producer.produce(collector_constants.LOG_SINK.ATTACKER_ACTIONS_TOPIC_NAME, record)
        emulation_env_agent_config.emulation_config.producer.flush()

    @staticmethod
    def execute_cmd_interactive(a: AttackerAction, emulation_env_agent_config: EmulationEnvAgentConfig) -> None:
        """
        ...
        :return: None
        """
        EmulationUtil.execute_cmd_interactive_channel(cmd=a.cmds[0],
                                                      channel=emulation_env_agent_config.emulation_config.agent_channel)
        emulation_env_agent_config.emulation_config.agent_channel.send(a.cmds[0] + "\n")
    ...
    @staticmethod
    def read_result_interactive(emulation_env_agent_config: EmulationEnvAgentConfig) -> str:
        """
        ...
        :return: the result
        """
        return EmulationUtil.read_result_interactive_channel(emulation_env_agent_config=emulation_env_agent_config,
                                                             channel=emulation_env_agent_config.emulation_config.agent_channel)

    @staticmethod
    def read_result_interactive_channel(emulation_env_agent_config: EmulationEnvAgentConfig, channel) -> str:
        """
        Reads the result of an action executed in interactive mode
    ...
    @staticmethod
    def _list_all_users(c: ConnectionObservationState, emulation_env_agent_config: EmulationEnvAgentConfig,
        ...
        :param emulation_env_agent_config: env config
