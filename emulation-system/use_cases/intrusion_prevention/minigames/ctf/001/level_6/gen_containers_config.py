...
def default_containers_config(network_id: int = 6) -> ContainersConfig:
    """
    ...
    containers = [
        ...
        NodeContainerConfig(name="hacker_kali_1", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf", version="0.0.1", level="6",
        ...
        NodeContainerConfig(name="honeypot_1", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_3", minigame="ctf",
