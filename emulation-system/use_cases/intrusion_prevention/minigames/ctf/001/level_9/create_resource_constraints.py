...
def default_resource_constraints(network_id: int = 9, level: int = 9) -> ResourcesConfig:
    ...
    node_resources_configurations = [
        ...
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.254",
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.253",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                                           f"{constants.CONTAINER_IMAGES.CLIENT_1}_2-{constants.CSLE.LEVEL}{level}",
                            num_cpus=1, available_memory_gb=4,
                            internal_network_config=NodeNetworkConfig(
                                interface=constants.NETWORKING.ETH0,
                                limit_packets_queue=30000, packet_delay_ms=2,
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.252",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                                           f"{constants.CONTAINER_IMAGES.CLIENT_1}_3-{constants.CSLE.LEVEL}{level}",
                            num_cpus=1, available_memory_gb=4,
                            internal_network_config=NodeNetworkConfig(
                                interface=constants.NETWORKING.ETH0,
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.7",
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.4",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.5",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.6",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.8",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.9",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.178",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
        ...
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.11",
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.12",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.13",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.14",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.15",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.16",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.17",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.18",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
        ...
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.19",
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.20",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.22",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.23",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.24",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.25",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                            ...
                            external_network_config=None),
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.28",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
                                           f"{constants.CONTAINER_IMAGES.CVE_2016_10033_1}_1_1-{constants.CSLE.LEVEL}{level}",
                            num_cpus=1, available_memory_gb=4,
                            internal_network_config=NodeNetworkConfig(
                                interface=constants.NETWORKING.ETH0,
                                limit_packets_queue=30000, packet_delay_ms=0.1,
