...
def default_containers_config() -> ContainersConfig:
    ...
    """
    containers = [
        NodeContainerConfig(name="client1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.254"),
        NodeContainerConfig(name="client1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.253"),
        NodeContainerConfig(name="client1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.252"),
        NodeContainerConfig(name="ftp1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.79"),
        NodeContainerConfig(name="hacker_kali1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.191"),
        NodeContainerConfig(name="honeypot1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.21"),
        NodeContainerConfig(name="router2", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.10"),
        NodeContainerConfig(name="ssh1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.2"),
        NodeContainerConfig(name="samba2", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.3"),
        NodeContainerConfig(name="samba1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.7"),
        NodeContainerConfig(name="honeypot2", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.101"),
        NodeContainerConfig(name="shellshock1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.54"),
        NodeContainerConfig(name="sql_injection1", network="csle_net_9", minigame="ctf", version="0.0.1", level="9",
                            ip="172.18.9.74"),
