...
def default_containers_config(network_id: int = 9) -> ContainersConfig:
    ...
    containers = [
        ...
        NodeContainerConfig(name="samba_2", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf",
                            version="0.0.1", level="9",
        ...
        NodeContainerConfig(name="cve_2015_3306_1", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_3",
                            minigame="ctf", version="0.0.1", level="9",
