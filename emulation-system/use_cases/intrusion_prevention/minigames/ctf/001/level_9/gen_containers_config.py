...
def default_containers_config(network_id: int = 9) -> ContainersConfig:
    """
    ...
    containers = [
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CLIENT_1}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf",
                            version="0.0.1", level="9",
                            ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.254"),
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CLIENT_1}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf",
                            version="0.0.1", level="9",
                            ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.253"),
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CLIENT_1}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf",
                            version="0.0.1", level="9",
                            ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.252"),
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.HACKER_KALI_1}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf", version="0.0.1", level="9",
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.SAMBA_2}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf",
                            version="0.0.1", level="9",
        ...
        NodeContainerConfig(name="cve_2010_0426", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_{network_id}",
                            minigame="ctf", version="0.0.1", level="9",
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2015_3306_1}", network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}_3",
                            minigame="ctf", version="0.0.1", level="9",
