...
def default_resource_constraints() -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(ip="172.18.4.191", container_name="csle-ctf-hacker_kali_1_1-level4",
        ...
        NodeResourcesConfig(ip="172.18.4.254", container_name="csle-ctf-client_1_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(ip="172.18.4.21", container_name="csle-ctf-honeypot_1_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
        ...
        NodeResourcesConfig(ip="172.18.4.10", container_name="csle-ctf-router_2_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.4.2", container_name="csle-ctf-ssh_1_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.4.3", container_name="csle-ctf-telnet_1_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.4.79", container_name="csle-ctf-ftp_1_1-level4",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
