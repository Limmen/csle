...
def default_resource_constraints(network_id: int = 4, level: int = 4) -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.191",
        ...
        NodeResourcesConfig(internal_ip=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.254",
                            container_name=f"{constants.CSLE.NAME}-{constants.CSLE.CTF_MINIGAME}-"
