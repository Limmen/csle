...
def default_resource_constraints() -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(ip="172.18.5.254", container_name="csle-ctf-client_1_1-level5",
        ...
        NodeResourcesConfig(ip="172.18.5.79", container_name="csle-ctf-ftp_1_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
        ...
        NodeResourcesConfig(ip="172.18.5.191", container_name="csle-ctf-hacker_kali_1_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(ip="172.18.5.21", container_name="csle-ctf-honeypot_1_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.10", container_name="csle-ctf-router_2_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.2", container_name="csle-ctf-ssh_1_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.3", container_name="csle-ctf-telnet_1_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.7", container_name="csle-ctf-ftp_2_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.101", container_name="csle-ctf-honeypot_2_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.54", container_name="csle-ctf-ssh_2_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.74", container_name="csle-ctf-ssh_3_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.61", container_name="csle-ctf-telnet_2_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.5.62", container_name="csle-ctf-telnet_3_1-level5",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
