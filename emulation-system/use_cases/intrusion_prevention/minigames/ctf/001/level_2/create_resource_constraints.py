...
def default_resource_constraints() -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(ip="172.18.2.254", container_name="csle-ctf-client_1_1-level2",
        ...
        NodeResourcesConfig(ip="172.18.2.79", container_name="csle-ctf-ftp_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
        ...
        NodeResourcesConfig(ip="172.18.2.191", container_name="csle-ctf-hacker_kali_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(ip="172.18.2.21", container_name="csle-ctf-honeypot_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.10", container_name="csle-ctf-router_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.2", container_name="csle-ctf-ssh_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.3", container_name="csle-ctf-telnet_1_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.7", container_name="csle-ctf-ftp_2_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.101", container_name="csle-ctf-honeypot_2_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.54", container_name="csle-ctf-ssh_2_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.74", container_name="csle-ctf-ssh_3_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.61", container_name="csle-ctf-telnet_2_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.2.62", container_name="csle-ctf-telnet_3_1-level2",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
