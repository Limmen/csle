...
def default_containers_config(network_id: int, level: str, version : str = "0.0.1") -> ContainersConfig:
    ...
    containers = [
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.TELNET_1}",
                            ...
                            connected_to_internal_net=True,
                            suffix="_1"),
        NodeContainerConfig(name="ftp_{network_id}", internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
        ...
        NodeContainerConfig(name="honeypot_{network_id}",
                            ...
                            connected_to_internal_net=True,
                            suffix="_1"),
        NodeContainerConfig(name="ssh_{network_id}", internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
