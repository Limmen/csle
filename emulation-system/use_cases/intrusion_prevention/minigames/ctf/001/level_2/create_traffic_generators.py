...
def default_traffic_generators(network_id: int = 2) -> TrafficConfig:
    """
    ...
    traffic_generators = [
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.254",
                          commands=[
                              ...
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 "
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.10",
                          commands=[
                              ...
                              f"> /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79:8080 > /dev/null 2>&1"
                          ],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                          commands=[
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79 > /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79:8080 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no "
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
                          commands=[
                              ...
                              f"timeout 10 /irc_login_test.sh "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 > /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 "
                              f"-p 5432 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              ...
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61:8080 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61 "
                              f"> /dev/null 2>&1"
                          ],
                          jumphosts=[
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79",
                          commands=[
                              ...
                              f"> /dev/null 2>&1",
                              f"timeout 5 psql -h "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 -p 5432 "
                              f"> /dev/null 2>&1"
                          ],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.54",
                          commands=[
                              ...
                              f"timeout 5 ftp "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p "
                              f"'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79 > /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79:8080 > /dev/null 2>&1"
                          ],
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.74",
                          commands=[
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2 > /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2:80 > /dev/null 2>&1",
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61:8080 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61 > /dev/null "
                              f"2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.62 > /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.62:8080 "
                              f"> /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.62 > /dev/null 2>&1"
                          ],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61",
                          commands=[
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' "
                              f"ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 > /dev/null 2>&1",
                              f"timeout 5 snmpwalk "
                              f"-v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 "
                              f"-c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 "
                              f"> /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.62",
                          commands=[
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 > /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 -c csle_ctf1234 > "
                              f"/dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 > /dev/null 2>&1",
                              f"timeout 5 psql -h "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.101 -p 5432 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.74 > /dev/null 2>&1",
                              ...
                              f"> /dev/null 2>&1",
                              f"timeout 5 sshpass "
                              f"-p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61 > /dev/null 2>&1",
                              f"timeout 5 curl "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61:8080 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
