    ...
    traffic_generators = [
        NodeTrafficConfig(ip="172.18.2.254",
                          commands=[
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.2 > /dev/null 2>&1 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.2.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.3 > /dev/null 2>&1 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.2.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.2.3 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.21 > /dev/null 2>&1",
                              "timeout 5 snmpwalk -v2c 172.18.2.21 -c csle_ctf1234 > /dev/null 2>&1",
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.79 > /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip="172.18.2.21",
                          commands=[
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.2 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.2.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.3 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.2.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.2.3 > /dev/null 2>&1",
                              "timeout 5 ftp 172.18.2.79 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.79 > /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip="172.18.2.2",
                          commands=[
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.79 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.2.79:8080 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.54 > /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip="172.18.2.3",
                          commands=[
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.7 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.2.7 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.101 > /dev/null 2>&1",
                              "timeout 5 snmpwalk -v2c 172.18.2.101 -c csle_ctf1234 > /dev/null 2>&1",
                              "timeout 10 /irc_login_test.sh 172.18.2.101 > /dev/null 2>&1",
                              "timeout 5 psql -h 172.18.2.101 -p 5432 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.74 > /dev/null 2>&1",
                              "timeout 10 /irc_login_test.sh 172.18.2.74 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.61 > /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip="172.18.2.101",
                          commands=[
                              ...
                              "timeout 5 curl 172.18.2.61:8080 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.2.61 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.2.62 > /dev/null 2>&1",
