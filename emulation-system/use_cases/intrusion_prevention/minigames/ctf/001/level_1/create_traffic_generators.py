...
def default_traffic_generators(network_id: int = 1) -> TrafficConfig:
    """
    ...
    traffic_generators = [
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}1.254",
                          commands=[
                              ...
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 > /dev/null 2>&1 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              "> /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"-c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 -p 5432 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 ftp {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' "
                              f"ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79:8080 "
                              f"> /dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 > /dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 > /dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 > /dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.10 > /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 "
                              f"> /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              f"> /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"> /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 "
                              f"> /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.10 "
                              f"> /dev/null 2>&1"
                          ],
                          jumphosts=[],
                          target_hosts=[
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21",
                          commands=[
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2:80 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              f"> /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              "> /dev/null 2>&1",
                              f"timeout 5 ftp {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.79:8080 "
                              f"> /dev/null 2>&1"
                          ],
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.10",
                          commands=[
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2:80 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh "
                              f"-oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              ...
                              f"-oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              "> /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"-c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                          commands=[
                              ...
                              f"ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              "> /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"-c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79",
                          commands=[
                              "timeout 5 sshpass -p 'testcsleuser' "
                              f"ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' "
                              f"ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              "> /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | "
                              f"telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.3 "
                              ...
                              "> /dev/null 2>&1",
                              "timeout 5 snmpwalk "
                              f"-v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"-c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}1.21 "
