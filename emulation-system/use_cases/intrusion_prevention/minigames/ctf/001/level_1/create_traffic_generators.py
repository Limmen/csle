    ...
    traffic_generators = [
        NodeTrafficConfig(ip="172.18.1.254",
                          commands=[
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.2 > /dev/null 2>&1 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.1.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.3 > /dev/null 2>&1 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.1.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.1.3 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.21 > /dev/null 2>&1",
                              "timeout 5 snmpwalk -v2c 172.18.1.21 -c csle_ctf1234 > /dev/null 2>&1",
                              ...
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.79 > /dev/null 2>&1",
        ...
        NodeTrafficConfig(ip="172.18.1.21",
                          commands=[
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.2 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.1.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.3 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.1.3 > /dev/null 2>&1",
                              "(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet 172.18.1.3 > /dev/null 2>&1",
                              "timeout 5 ftp 172.18.1.79 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no 172.18.1.79 > /dev/null 2>&1",
