...
def default_topology(network_id: int = 1) -> Topology:
    ...
    node_1 = NodeFirewallConfig(
        ...
        internal_subnetwork_mask=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}"
                                 f"{constants.CSLE.CSLE_SUBNETMASK_SUFFIX}",
        external_subnetwork_mask=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}"
                                 f"{constants.CSLE.CSLE_SUBNETMASK_SUFFIX}",
        output_accept=set([]),
        input_accept=set([]),
        forward_accept=set([]),
        output_drop=set(), input_drop=set(), forward_drop=set(), routes=set(),
        default_internal_input=constants.FIREWALL.ACCEPT, default_internal_output=constants.FIREWALL.ACCEPT,
        default_internal_forward=constants.FIREWALL.ACCEPT,
        default_external_input=constants.FIREWALL.ACCEPT, default_external_output=constants.FIREWALL.ACCEPT,
        default_external_forward=constants.FIREWALL.ACCEPT,
        default_internal_gw=None, default_external_gw=None)
    node_2 = NodeFirewallConfig(
        ...
        default_external_input=constants.FIREWALL.ACCEPT, default_external_output=constants.FIREWALL.ACCEPT,
        default_external_forward=constants.FIREWALL.DROP,
        default_internal_gw=None,
        default_external_gw=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.10"
    )
    ...
    node_6 = NodeFirewallConfig(
        ip=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.191",
        ...
        default_external_input=constants.FIREWALL.ACCEPT, default_external_output=constants.FIREWALL.ACCEPT,
        default_external_forward=constants.FIREWALL.DROP,
        default_external_gw=None,
        default_internal_gw=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.10")
    node_7 = NodeFirewallConfig(
        ip=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.254",
    ...
    topology = Topology(node_configs=node_configs,
                        subnetwork_masks=[
                            f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}"
                            f"{constants.CSLE.CSLE_SUBNETMASK_SUFFIX}",
                            f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}"
                            f"{constants.CSLE.CSLE_SUBNETMASK_SUFFIX}"
                        ])
    return topology
