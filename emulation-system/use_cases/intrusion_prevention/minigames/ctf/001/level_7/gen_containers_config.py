...
def default_containers_config() -> ContainersConfig:
    ...
    """
    containers = [
        NodeContainerConfig(name="client1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.254"),
        NodeContainerConfig(name="ftp1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.79"),
        NodeContainerConfig(name="hacker_kali1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.191"),
        NodeContainerConfig(name="honeypot1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.21"),
        NodeContainerConfig(name="router2", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.10"),
        NodeContainerConfig(name="ssh1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.2"),
        NodeContainerConfig(name="telnet1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.3"),
        NodeContainerConfig(name="samba1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.19"),
        NodeContainerConfig(name="shellshock1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.31"),
        NodeContainerConfig(name="sql_injection1", network="csle_net_7", minigame="ctf", version="0.0.1", level="7",
                            ip="172.18.7.42"),
