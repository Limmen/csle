...
def default_resource_constraints() -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(ip="172.18.8.191", container_name="csle-ctf-hacker_kali_1_1-level8",
        ...
        NodeResourcesConfig(ip="172.18.8.254", container_name="csle-ctf-client_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(ip="172.18.8.21", container_name="csle-ctf-honeypot_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
        ...
        NodeResourcesConfig(ip="172.18.8.10", container_name="csle-ctf-router_2_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.2", container_name="csle-ctf-ssh_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.3", container_name="csle-ctf-telnet_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.79", container_name="csle-ctf-ftp_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.19", container_name="csle-ctf-samba_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.31", container_name="csle-ctf-shellshock_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.42", container_name="csle-ctf-sql_injection_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.37", container_name="csle-ctf-cve_2015_3306_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.82", container_name="csle-ctf-cve_2015_1427_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.75", container_name="csle-ctf-cve_2016_10033_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.71", container_name="csle-ctf-cve_2010_0426_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.11", container_name="csle-ctf-cve_2015_5602_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.51", container_name="csle-ctf-ssh_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.52", container_name="csle-ctf-ssh_1_3-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.53", container_name="csle-ctf-honeypot_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.54", container_name="csle-ctf-samba_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.55", container_name="csle-ctf-shellshock_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.56", container_name="csle-ctf-sql_injection_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.57", container_name="csle-ctf-cve_2015_3306_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.58", container_name="csle-ctf-cve_2015_1427_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.59", container_name="csle-ctf-cve_2016_10033_1_2-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.61", container_name="csle-ctf-cve_2015_5602_1_1-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.8.62", container_name="csle-ctf-ssh_1_4-level8",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
