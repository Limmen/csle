...
def default_containers_config(network_id: int = 8, level: str = "8", version: str = "0.0.1") -> ContainersConfig:
    ...
    containers = [
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.SSH_1}",
                            ...
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.51",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.SSH_1}",
                            ...
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.52",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.HONEYPOT_1}",
                            ...
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.53",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.SHELLSHOCK_1}",
                            ...
                            minigame=constants.CSLE.CTF_MINIGAME,
                            version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.55",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.SQL_INJECTION_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.56",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2015_3306_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version, level=level,
                            internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.57",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2015_1427_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version,
                            level=level, internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.58",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2016_10033_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version,
                            level=level, internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.59",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2010_0426_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version,
                            level=level, internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.60",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
                            external_ip=f"{constants.CSLE.CSLE_EXTERNAL_SUBNETMASK_PREFIX}{network_id}.60",
                            external_network=f"{constants.CSLE.CSLE_EXTERNAL_NET_PREFIX}{network_id}",
                            connected_to_external_net=False,
                            connected_to_internal_net=True,
                            suffix="_2"),
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2015_5602_1}",
                            internal_network=f"{constants.CSLE.CSLE_INTERNAL_NET_PREFIX}{network_id}",
                            minigame=constants.CSLE.CTF_MINIGAME, version=version,
                            level=level, internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.61",
                            restart_policy=constants.DOCKER.ON_FAILURE_3,
