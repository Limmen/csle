...
def default_flags(network_id: int = 10) -> FlagsConfig:
    """
    ...
    flags = [
        ...
        NodeFlagsConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104",
                        flags=[("/root/flag12.txt", "flag12", "/root/", 12, True, 1)])
    ]
