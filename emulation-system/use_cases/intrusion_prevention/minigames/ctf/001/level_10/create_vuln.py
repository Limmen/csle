...
def default_vulns(network_id: int = 10) -> VulnerabilitiesConfig:
    """
    ...
    vulns = [
        ...
        RceVulnerabilityConfig(node_internal_ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104",
                               vuln_type=VulnType.RCE)
    ]
