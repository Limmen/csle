...
def default_resource_constraints() -> ResourcesConfig:
    ...
    node_resources_configurations = [
        NodeResourcesConfig(ip="172.18.10.191", container_name="csle-ctf-hacker_kali_1_1-level10",
        ...
        NodeResourcesConfig(ip="172.18.10.254", container_name="csle-ctf-client_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=2,
        ...
        NodeResourcesConfig(ip="172.18.10.21", container_name="csle-ctf-honeypot_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
        ...
        NodeResourcesConfig(ip="172.18.10.10", container_name="csle-ctf-router_2_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.2", container_name="csle-ctf-ssh_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.3", container_name="csle-ctf-telnet_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.79", container_name="csle-ctf-ftp_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.19", container_name="csle-ctf-samba_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.31", container_name="csle-ctf-shellshock_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.42", container_name="csle-ctf-sql_injection_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.37", container_name="csle-ctf-cve_2015_3306_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.82", container_name="csle-ctf-cve_2015_1427_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.75", container_name="csle-ctf-cve_2016_10033_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.71", container_name="csle-ctf-cve_2010_0426_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.11", container_name="csle-ctf-cve_2015_5602_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
        ...
        NodeResourcesConfig(ip="172.18.10.104", container_name="csle-ctf-pengine_exploit_1_1_1-level10",
                            num_cpus = 1, available_memory_gb = 4,
                            network_config=NodeNetworkConfig(
                                interface="eth0",
                                limit_packets_queue=30000, packet_delay_ms=0.1,
