    ...
    traffic_generators = [
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.254",
                          commands=[
                              ...
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104:4000 "
                              f"> /dev/null 2>&1",
                              f"timeout 5 curl "
                              ...
                              "[_,_,_,_,4,_,_,_,9]]).\n\"}' "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104:4000/pengine/create",
                              ...
                              f"/dev/null 2>&1",
                              f"timeout 15 ping {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104 > "
                              f"/dev/null 2>&1",
                              ...
                              f"> /dev/null 2>&1",
                              f"timeout 25 traceroute {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}"
                              f"{network_id}.104 > /dev/null 2>&1"
                          ],
                          jumphosts=[],
                          target_hosts=[
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.191", commands=[],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.10", commands=[
            ...
            f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
            f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104 > /dev/null 2>&1",
            f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104:4000 > /dev/null 2>&1",
            f"timeout 5 curl "
            "--header \"Content-Type: application/json\" --request POST \
                              --data $'{\"application\": \"pengine_sandbox\", "
            "\"ask\": \"problem(1, Rows), sudoku(Rows)\", \"chunk\": 1, \"destroy\": true, "
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.82",
                          commands=[
                              ...
                              "[_,9,_,_,_,_,_,_,_],[5,_,_,_,_,_,_,7,3],[_,_,2,_,1,_,_,_,_],"
                              "[_,_,_,_,4,_,_,_,9]]).\n\"}' "
                              "{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104:4000/pengine/create"
                          ],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
        ...
        NodeTrafficConfig(ip=f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.104",
                          commands=[
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no "
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2:80 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 > /dev/null 2>&1",
                              f"(sleep 2; echo test; sleep 2; echo test; sleep 3;) | telnet {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 > /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 -c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 > /dev/null 2>&1",
                              f"timeout 5 psql -h {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.21 -p 5432 > /dev/null 2>&1",
                              f"timeout 5 ftp {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.79:8080 > /dev/null 2>&1",
                              ...
                              f"(sleep 2; echo testcsleuser; sleep 3;) | smbclient -L {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.19 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.31 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.31 > /dev/null 2>&1",
                              f"timeout 5 snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.31 -c csle_ctf1234 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.42 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.42/login.php > /dev/null 2>&1",
                              f"timeout 10 /irc_login_test.sh {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.42 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.37 > /dev/null 2>&1",
                              "snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.37 -c csle_ctf1234",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.37 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.82 > /dev/null 2>&1",
                              "snmpwalk -v2c {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.82 -c csle_ctf1234",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.75 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.75 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.71 > /dev/null 2>&1",
                              f"timeout 5 curl {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.71:8080 > /dev/null 2>&1",
                              f"timeout 5 sshpass -p 'testcsleuser' ssh -oStrictHostKeyChecking=no {constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.11 > /dev/null 2>&1"
                          ],
                          jumphosts=[
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.2",
                              f"{constants.CSLE.CSLE_INTERNAL_SUBNETMASK_PREFIX}{network_id}.3",
