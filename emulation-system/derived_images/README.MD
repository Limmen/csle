...
- `cve_2010_0426_1` ([cve_2010_0426_1](./cve_2010_0426_1)): an image with the CVE-2010-0426 vulnerability.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_cve_2010_0426_1:0.0.1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_cve_2010_0426_1:0.0.1/)
     - OS: Debian:Jessie. 
...
- `cve_2015_1427_1` ([cve_2015_1427_1](./cve_2015_1427_1)): an image with the CVE-2015-1427 vulnerability.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_cve_2015_1427_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_cve_2015_1427_1/)
     - OS: Debian:Jessie. 
...
- `cve_2015_3306_1` ([cve_2015_3306_1](./cve_2015_3306_1)): an image with the CVE-2015-3306 vulnerability.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_cve_2015_3306_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_cve_2015_3306_1/)
     - OS: Debian:Jessie. 
...
- `cve_2015_5602_1` ([cve_2015_5602_1](./cve_2015_5602_1)): an image with the CVE-2015-5602 vulnerability.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_cve_2015_5602_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_cve_2015_5602_1/)
     - OS: Debian:Jessie. 
...
- `cve_2016_10033_1` ([cve_2016_10033_1](./cve_2016_10033_1)): an image with the CVE-2016-10033 vulnerability.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_cve_2016_10033_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_cve_2016_10033_1/)
     - OS: Debian:Jessie. 
...
- `hacker_kali_1` ([hacker_kali_1](./hacker_kali_1)): a Kali image, used to generate containers with tools for penetration testing.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_hacker_kali_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_hacker_kali_1/)
     - OS: Kali (Latest). 
...
- `samba_1` ([samba_1](./samba_1)): an image with the SambaCry CVE-2017-7494 vulnerabilitiy.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_samba_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_samba_1/)
     - OS: Debian:Jessie. 
...
- `samba_2` ([samba_2](./samba_2)): an image with the SambaCry CVE-2017-7494 vulnerabilitiy and a telnet server.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_samba_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_samba_2/)
     - OS: Debian:Jessie. 
     - Inherits from `samba_base`.
...
- `shellshock_1` ([shellshock_1](./shellshock_1)): an image with the ShellShock CVE-2014-6271 vulnerabilitiy.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_shellshock_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_shellshock_1/)
     - OS: Debian:Wheezy. 
...
- `sql_injection_1` ([sql_injection_1](./sql_injection_1)): an image with a webapp that is vulnerable to SQL injections.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_sql_injection_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_sql_injection_1/)
     - OS: Debian:9.2. 
...
- `ftp_1` ([ftp_1](./ftp_1)): an image with a FTP server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ftp_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ftp_1/)
     - OS: Ubuntu:14. 
...
- `ftp_2` ([ftp_2](./ftp_2)): an image with a FTP server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ftp_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ftp_2/)
     - OS: Ubuntu:14. 
     - Inherits from `ubuntu_14_base`.
...
- `ssh_1` ([ssh_1](./ssh_1)): an image with a SSH server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ssh_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ssh_1/)
     - OS: Ubuntu:20. 
...
- `ssh_2` ([ssh_2](./ssh_2)): an image with a SSH server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ssh_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ssh_2/)
     - OS: Ubuntu:20. 
     - Inherits from `ssh_base`.
...
- `ssh_3` ([ssh_3](./ssh_3)): an image with a SSH server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ssh_3?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ssh_3/)
     - OS: Ubuntu:20. 
     - Inherits from `ssh_base`.
...
- `telnet_1` ([telnet_1](./telnet_1)): an image with a Telnet server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_telnet_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_telnet_1/)
     - OS: Ubuntu:20. 
...
- `telnet_2` ([telnet_2](./telnet_2)): an image with a Telnet server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_telnet_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_telnet_2/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
...
- `telnet_3` ([telnet_3](./telnet_3)): an image with a Telnet server that can be used to generate containers vulnerable to brute-force attacks.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_telnet_3?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_telnet_3/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
...
- `honeypot_1` ([honeypot_1](./honeypot_1)): an image with a set of arbitrary network services that can be used to generate honeypot containers.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_honeypot_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_honeypot_1/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
...
- `honeypot_2` ([honeypot_2](./honeypot_2)): an image with a set of arbitrary network services that can be used to generate honeypot containers.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_honeypot_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_honeypot_2/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
...
- `router_1` ([router_1](./router_1)): an image without any particular services that can be used to generate containers acting as gateways.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_router_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_router_1/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
     - Services: ssh
- `router_2` ([router_2](./router_2)): an image with the Snort IDS that can be used to generate containers acting as gateways.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_router_2?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_router_2/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
     - Services: ssh, Snort
- `client_1` ([client_1](./client_1)): an image without any particular services that can be used to generate containers acting as clients.
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_client_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_client_1/)
     - OS: Ubuntu:20. 
     - Inherits from `ubuntu_20_base`.
     - Services: ssh
- `blank_1` ([blank_1](./blank_1)): a blank image for testing purposes
    ...
    - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_blank_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_blank_1/)
    - OS: Ubuntu:20. 
...
- `pengine_exploit_1` ([pengine_exploit_1](./pengine_exploit_1)): an image with a vulnerable Prolog SLD Pengine Server
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_pengine_exploit_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_pengine_exploit_1/)
     - OS: Ubuntu:20. 
...
- `ovs_1` ([ovs_1](./ovs_1)): an image with a OVS virtual switch
    ...
    - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ovs_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ovs_1/)
    - OS: Ubuntu:20.
...
- `ryu_1` ([ryu_1](./ryu_1)): an image with the Ryu SDN controller
    ...
    - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_ryu_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_ryu_1/)
    - OS: Ubuntu:20.
...
- `elk_1` ([elk_1](./elk_1)): an image with the ELK stack
    ...
    - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_elk_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_elk_1/)
    - OS: Ubuntu:20.
...
- `kafka_1` ([kafka_1](./kafka_1)): an image with Kafka
     ...
     - [![Docker Image Size](https://badgen.net/docker/size/kimham/csle_kafka_1?icon=docker&label=image%20size)](https://hub.docker.com/r/kimham/csle_kafka_1/)
     - OS: Ubuntu:20.
     - Inherits from `ubuntu_20_base`.
     - Services: Kafka, SSH
...
make push_debian_jessie_base # Push debian_jessie_1 to DockerHub
...
make push_blank_1 # Push blank_1 to DockerHub
...
make pull_debian_jessie_base # pull debian_jessie_1 from DockerHub
...
make pull_blank_1 # pull blank_1 from DockerHub
