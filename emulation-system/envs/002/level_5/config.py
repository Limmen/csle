...
def default_config(name: str, network_id: int = 5, level: int = 5, version: str = "0.0.2") -> EmulationEnvConfig:
    """
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level5-002", network_id=5, level=5, version="0.0.2")
