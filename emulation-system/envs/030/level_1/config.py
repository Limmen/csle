...
def default_config(name: str, network_id: int = 1, level: int = 1, version: str = "0.3.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level1-030", network_id=1, level=1, version="0.3.0", time_step_len_seconds=15)
