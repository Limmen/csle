...
def default_config(name: str, network_id: int = 3, level: int = 3, version: str = "0.3.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level3-030", network_id=3, level=3, version="0.3.0", time_step_len_seconds=15)
