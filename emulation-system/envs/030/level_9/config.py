...
def default_config(name: str, network_id: int = 9, level: int = 9, version: str = "0.3.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level9-030", network_id=9, level=9, version="0.3.0", time_step_len_seconds=30)
