...
def default_config(name: str, network_id: int = 6, level: int = 6, version: str = "0.3.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level6-030", network_id=6, level=6, version="0.3.0", time_step_len_seconds=15)
