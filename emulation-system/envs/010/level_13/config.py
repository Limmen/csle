...
def default_config(name: str, network_id: int = 12, level: int = 13, version: str = "0.1.0") -> EmulationEnvConfig:
    """
                            ...
                            ips_and_networks=[
                                ...
                                (f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}."
                                 ...
                                 ContainerNetwork(
                                     ...
                                     subnet_mask=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}"
                                                 f"{network_id}.{ryu_constants.RYU.NETWORK_ID_THIRD_OCTET}.0"
...
def default_sdn_controller_config(network_id: int, level: int, version: str) -> Union[None, SDNControllerConfig]:
    ...
    sdn_controller_config = SDNControllerConfig(
        ...
        manager_max_workers=10, manager_log_dir=collector_constants.LOG_FILES.RYU_MANAGER_LOG_DIR,
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level13-010", network_id=13, level=13, version="0.1.0")
