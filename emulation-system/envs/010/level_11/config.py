...
def default_config(name: str, network_id: int = 11, level: int = 11, version: str = "0.1.0") -> EmulationEnvConfig:
    """
...
def default_docker_stats_manager_config(network_id: int, level: int, version: str) -> DockerStatsManagerConfig:
    ...
    config = DockerStatsManagerConfig(
        ...
        docker_stats_manager_log_dir=collector_constants.LOG_FILES.DOCKER_STATS_MANAGER_LOG_DIR, docker_stats_manager_max_workers=10)
    return config
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level11-010", network_id=11, level=11, version="0.1.0")
