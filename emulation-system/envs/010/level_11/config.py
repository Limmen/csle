...
def default_config(name: str, network_id: int = 11, level: int = 11, version: str = "0.1.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level11-010", network_id=11, level=11, version="0.1.0", time_step_len_seconds=30)
