...
def default_config(name: str, network_id: int = 5, level: int = 5, version: str = "0.1.0") -> EmulationEnvConfig:
    """
...
def default_kafka_config(network_id: int, level: int, version: str) -> KafkaConfig:
    ...
    config = KafkaConfig(container=container, resources=resources, topics=topics, firewall_config=firewall_config,
                         ...
                         kafka_manager_port=50051, time_step_len_seconds=15,
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level5-010", network_id=5, level=5, version="0.1.0")
