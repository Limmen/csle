...
def default_config(name: str, network_id: int = 7, level: int = 7, version: str = "0.1.0") -> EmulationEnvConfig:
    """
...
def default_kafka_config(network_id: int, level: int, version: str) -> KafkaConfig:
    ...
    config = KafkaConfig(container=container, resources=resources, firewall_config=firewall_config,
                         ...
                         kafka_port=9092, kafka_port_external=9292,
...
def default_elk_config(network_id: int, level: int, version: str) -> ElkConfig:
    ...
    config = ElkConfig(version=version, time_step_len_seconds=15, elastic_port=9200, kibana_port=5601,
                       logstash_port=5044, elk_manager_port=collector_constants.MANAGER_PORTS.ELK_MANAGER_DEFAULT_PORT,
                       container=container,
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level7-010", network_id=7, level=7, version="0.1.0")
