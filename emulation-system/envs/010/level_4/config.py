...
def default_config(name: str, network_id: int = 4, level: int = 4, version: str = "0.1.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level4-010", network_id=4, level=4, version="0.1.0", time_step_len_seconds=30)
