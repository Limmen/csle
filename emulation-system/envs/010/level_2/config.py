...
def default_config(name: str, network_id: int = 2, level: int = 2, version: str = "0.1.0",
                            ...
                            ips_and_networks=[
                                (f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}.2.21",
                                 ContainerNetwork(
                                     ...
                                     subnet_mask=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}"
                                                 f"{network_id}."
                                                 f"2{constants.CSLE.CSLE_EDGE_SUBNETMASK_SUFFIX}",
                                     subnet_prefix=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level2-010", network_id=2, level=2, version="0.1.0", time_step_len_seconds=15)
