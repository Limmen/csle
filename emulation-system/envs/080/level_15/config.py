...
def default_config(name: str, network_id: int = 15, level: int = 15, version: str = "0.8.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level15-080", network_id=15, level=15, version="0.8.0", time_step_len_seconds=30)
