...
def default_config(name: str, network_id: int = 2, level: int = 2, version: str = "0.8.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level2-080", network_id=2, level=2, version="0.8.0", time_step_len_seconds=15)
