...
def default_config(name: str, network_id: int = 8, level: int = 8, version: str = "0.8.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level8-080", network_id=8, level=8, version="0.8.0", time_step_len_seconds=30)
