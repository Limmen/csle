...
def default_config(name: str, network_id: int = 1, level: int = 1, version: str = "0.8.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level1-080", network_id=1, level=1, version="0.8.0", time_step_len_seconds=15)
