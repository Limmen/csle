...
def default_config(name: str, network_id: int = 7, level: int = 7, version: str = "0.0.1") -> EmulationEnvConfig:
    """
    ...
    descr = "An emulation environment with a set of nodes that run common networked services such as " \
            ...
            "Cassandra, etc. Some of the services are vulnerable to different network " \
...
def default_log_sink_config(network_id: int, level: int, version: str) -> LogSinkConfig:
    ...
    config = LogSinkConfig(container=container, resources=resources, firewall_config=firewall_config,
                           topics=topics, version=version,
                           kafka_port=9092, default_grpc_port=50051, secondary_grpc_port = 50049,
                           third_grpc_port=50048, time_step_len_seconds=15)
    return config
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level7-001", network_id=7, level=7, version="0.0.1")
