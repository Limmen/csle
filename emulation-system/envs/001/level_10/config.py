    ...
    containers = [
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.PENGINE_EXPLOIT_1}",
                            ...
                            ips_and_networks = [
                                ...
                                (f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}."
                                 f"{collector_constants.LOG_SINK.NETWORK_ID_THIRD_OCTET}.104",
                                 ContainerNetwork(
                                     name=f"{constants.CSLE.CSLE_NETWORK_PREFIX}{network_id}_"
                                          f"{collector_constants.LOG_SINK.NETWORK_ID_THIRD_OCTET}",
                                     subnet_mask=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}"
        ...
        NodeContainerConfig(name=f"{constants.CONTAINER_IMAGES.CVE_2014_0160_1}",
                            ...
                            ips_and_networks = [
                                ...
                                (f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}."
                                 f"{collector_constants.LOG_SINK.NETWORK_ID_THIRD_OCTET}.204",
                                 ContainerNetwork(
                                     name=f"{constants.CSLE.CSLE_NETWORK_PREFIX}{network_id}_"
                                          f"{collector_constants.LOG_SINK.NETWORK_ID_THIRD_OCTET}",
                                     subnet_mask=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}"
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level10-001", network_id=10, level=10, version="0.0.1")
