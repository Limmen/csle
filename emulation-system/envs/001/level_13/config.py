...
def default_config(name: str, network_id: int = 13, level: int = 13, version: str = "0.0.1") -> EmulationEnvConfig:
    """
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level13-001", network_id=13, level=13, version="0.0.1")
