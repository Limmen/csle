...
def default_config(name: str, network_id: int = 14, level: int = 14, version: str = "0.9.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level14-080", network_id=14, level=14, version="0.9.0", time_step_len_seconds=30)
