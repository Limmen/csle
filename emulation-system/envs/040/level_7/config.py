...
def default_config(name: str, network_id: int = 7, level: int = 7, version: str = "0.4.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level7-040", network_id=7, level=7, version="0.4.0", time_step_len_seconds=30)
