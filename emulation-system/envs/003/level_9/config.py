...
def default_config(name: str, network_id: int = 9, level: int = 9, version: str = "0.0.3") -> EmulationEnvConfig:
    """
...
def default_traffic_config(network_id: int) -> TrafficConfig:
    ...
    client_population_config = ClientPopulationConfig(
        ...
        lamb=20, mu=4, client_manager_port=50044, num_commands=2, client_time_step_len_seconds=30,
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level9-003", network_id=9, level=9, version="0.0.3")
