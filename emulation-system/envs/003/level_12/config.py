...
def default_config(name: str, network_id: int = 12, level: int = 12, version: str = "0.0.3") -> EmulationEnvConfig:
    """
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level12-003", network_id=12, level=12, version="0.0.3")
