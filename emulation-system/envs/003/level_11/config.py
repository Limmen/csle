...
def default_config(name: str, network_id: int = 11, level: int = 11, version: str = "0.0.3") -> EmulationEnvConfig:
    """
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level11-003", network_id=11, level=11, version="0.0.3")
