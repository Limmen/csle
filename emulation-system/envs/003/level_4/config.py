...
def default_config(name: str, network_id: int = 4, level: int = 4, version: str = "0.0.3") -> EmulationEnvConfig:
    """
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level4-003", network_id=4, level=4, version="0.0.3")
