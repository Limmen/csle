...
def default_config(name: str, network_id: int = 12, level: int = 12, version: str = "0.2.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level12-020", network_id=12, level=12, version="0.2.0", time_step_len_seconds=30)
