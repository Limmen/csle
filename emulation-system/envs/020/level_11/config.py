...
def default_config(name: str, network_id: int = 11, level: int = 11, version: str = "0.2.0",
...
def default_traffic_config(network_id: int, time_step_len_seconds: int) -> TrafficConfig:
    ...
    client_population_config = ClientPopulationConfig(
        ...
        ip=f"{constants.CSLE.CSLE_SUBNETMASK_PREFIX}{network_id}."
           f"{collector_constants.EXTERNAL_NETWORK.NETWORK_ID_THIRD_OCTET}.254",
        client_process_type=ClientArrivalType.SINE_MODULATED_POISSON,
        lamb=20, mu=4,
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level11-020", network_id=11, level=11, version="0.2.0", time_step_len_seconds=30)
