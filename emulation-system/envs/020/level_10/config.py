...
def default_config(name: str, network_id: int = 10, level: int = 10, version: str = "0.2.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level10-020", network_id=10, level=10, version="0.2.0", time_step_len_seconds=30)
