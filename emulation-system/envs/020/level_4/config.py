...
def default_config(name: str, network_id: int = 4, level: int = 4, version: str = "0.2.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level4-020", network_id=4, level=4, version="0.2.0", time_step_len_seconds=30)
