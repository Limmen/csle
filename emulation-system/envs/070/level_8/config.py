...
def default_config(name: str, network_id: int = 8, level: int = 8, version: str = "0.5.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level8-070", network_id=8, level=8, version="0.7.0", time_step_len_seconds=30)
