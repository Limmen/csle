...
def default_config(name: str, network_id: int = 5, level: int = 5, version: str = "0.5.0",
...
if __name__ == '__main__':
    ...
    config = default_config(name="csle-level5-070", network_id=5, level=5, version="0.7.0", time_step_len_seconds=30)
