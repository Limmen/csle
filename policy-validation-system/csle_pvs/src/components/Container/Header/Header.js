...
import mdp from "./csle_101_s1.png"
                ...
                <div className="col-sm-8 p-5 mb-4 bg-light rounded-3 jumbotron">
                    ...
                    <ul className="nav nav-tabs justify-content-center navtabsheader">
                        <li className="nav-item navtabheader">
                                <NavLink className="nav-link navtablabel largeFont" to={"demo"} activeClassName="active"
                                         onClick={handleSelectNonNavBar}>
                                    Demo
                                </NavLink>
                        </li>
                        <li className="nav-item navtabheader">
                            <NavDropdown className="navdropdownheader largeFont" title="Training" id="basic-nav-dropdown"
                        ...
                        <li className="nav-item dropdown navtabheader">
                            <Nav activeKey={activeNavKey} onSelect={handleSelect}>
                                <NavDropdown className="navdropdownheader largeFont" title="Logs" id="basic-nav-dropdown"
                        ...
                        <li className="nav-item dropdown navtabheader">
                            <Nav activeKey={activeNavKey} onSelect={handleSelect}>
                                <NavDropdown className="navdropdownheader largeFont" title="Configurations" id="basic-nav-dropdown"
