...
def default_flags() -> FlagsConfig:
    flags = [
        NodeFlagsConfig(ip="172.18.6.79", flags = [("/tmp/flag3.txt", "flag3")]),
        NodeFlagsConfig(ip="172.18.6.2", flags=[("/tmp/flag2.txt", "flag2")]),
        NodeFlagsConfig(ip="172.18.6.3", flags=[("/root/flag1.txt", "flag1")]),
        NodeFlagsConfig(ip="172.18.6.54", flags=[("/tmp/flag4.txt", "flag4")]),
        NodeFlagsConfig(ip="172.18.6.61", flags=[("/root/flag5.txt", "flag5")]),
        NodeFlagsConfig(ip="172.18.6.7", flags=[("/tmp/flag6.txt", "flag6")])
    ]
