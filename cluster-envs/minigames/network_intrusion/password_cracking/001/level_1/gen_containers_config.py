...
def default_containers_config():
    containers = [
        NodeContainerConfig(name="ftp1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1", ip="172.18.1.79"),
        NodeContainerConfig(name="hacker_kali1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1",
                            ip="172.18.1.191"),
        NodeContainerConfig(name="honeypot1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1",
                            ip="172.18.1.21"),
        NodeContainerConfig(name="router1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1",
                            ip="172.18.1.10"),
        NodeContainerConfig(name="ssh1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1",
                            ip="172.18.1.2"),
        NodeContainerConfig(name="telnet1", network="pycr_net_1", minigame="pwcrack", version="0.0.1", level="1",
                            ip="172.18.1.3")
    ]
