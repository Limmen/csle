...
def default_flags() -> FlagsConfig:
    flags = [
        NodeFlagsConfig(ip="172.18.5.79", flags = [("/tmp/flag3.txt", "flag3")]),
        NodeFlagsConfig(ip="172.18.5.2", flags=[("/tmp/flag2.txt", "flag2")]),
        NodeFlagsConfig(ip="172.18.5.3", flags=[("/root/flag1.txt", "flag1")]),
        NodeFlagsConfig(ip="172.18.5.54", flags=[("/tmp/flag4.txt", "flag4")]),
        NodeFlagsConfig(ip="172.18.5.61", flags=[("/root/flag5.txt", "flag5")]),
        NodeFlagsConfig(ip="172.18.5.7", flags=[("/tmp/flag6.txt", "flag6")])
    ]
