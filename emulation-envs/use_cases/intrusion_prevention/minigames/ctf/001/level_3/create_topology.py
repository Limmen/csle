...
def default_topology() -> Topology:
    ...
    node_2 = NodeFirewallConfig(ip="172.18.3.2", hostname="ssh1",
                                output_accept=set(
    ...
    node_3 = NodeFirewallConfig(ip="172.18.3.3", hostname="telnet1",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
    ...
    node_4 = NodeFirewallConfig(ip="172.18.3.21", hostname="honeypot1_1",
    ...
    node_5 = NodeFirewallConfig(ip="172.18.3.79", hostname="ftp1",
                                output_accept=set(
                                    ["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79", "172.18.3.191",
                                     "172.18.3.10", "172.18.3.1", "172.18.3.254"]),
                                input_accept=set(
    ...
    node_6 = NodeFirewallConfig(ip="172.18.3.191", hostname="hacker_kali1",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21",
    ...
    node_7 = NodeFirewallConfig(ip="172.18.3.54", hostname="ssh2",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
    ...
    node_8 = NodeFirewallConfig(ip="172.18.3.74", hostname="ssh3",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
    ...
    node_9 = NodeFirewallConfig(ip="172.18.3.61", hostname="telnet2",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
                                                   "172.18.3.191", "172.18.3.10", "172.18.3.61", "172.18.3.74",
    ...
    node_10 = NodeFirewallConfig(ip="172.18.3.62", hostname="telnet3",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
                                                   "172.18.3.191", "172.18.3.10", "172.18.3.61", "172.18.3.74",
                                                   "172.18.3.1", "172.18.3.254",
    ...
    node_11 = NodeFirewallConfig(ip="172.18.3.101", hostname="honeypot2_1",
                                 output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
                                                    "172.18.3.191", "172.18.3.10", "172.18.3.61", "172.18.3.74",
                                                    "172.18.3.101", "172.18.3.62", "172.18.3.1", "172.18.3.254"]),
    ...
    node_12 = NodeFirewallConfig(ip="172.18.3.7", hostname="ftp2",
                                 output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21", "172.18.3.79",
                                                    "172.18.3.191", "172.18.3.10", "172.18.3.61", "172.18.3.74",
    ...
    node_13 = NodeFirewallConfig(ip="172.18.3.4", hostname="honeypot1_2",
                                 ...
                                 default_gw=None)
    node_14 = NodeFirewallConfig(ip="172.18.3.5", hostname="honeypot1_3",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_15 = NodeFirewallConfig(ip="172.18.3.6", hostname="honeypot1_4",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_16 = NodeFirewallConfig(ip="172.18.3.8", hostname="honeypot1_5",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_17 = NodeFirewallConfig(ip="172.18.3.9", hostname="honeypot1_6",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_18 = NodeFirewallConfig(ip="172.18.3.178", hostname="honeypot1_7",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_19 = NodeFirewallConfig(ip="172.18.3.11", hostname="honeypot2_2",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_20 = NodeFirewallConfig(ip="172.18.3.12", hostname="honeypot2_3",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_21 = NodeFirewallConfig(ip="172.18.3.13", hostname="honeypot2_4",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_22 = NodeFirewallConfig(ip="172.18.3.14",  hostname="honeypot2_5",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_23 = NodeFirewallConfig(ip="172.18.3.15", hostname="honeypot2_6",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_24 = NodeFirewallConfig(ip="172.18.3.16", hostname="honeypot2_7",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_25 = NodeFirewallConfig(ip="172.18.3.17", hostname="honeypot2_8",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_26 = NodeFirewallConfig(ip="172.18.3.18", hostname="honeypot2_9",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_27 = NodeFirewallConfig(ip="172.18.3.19", hostname="honeypot2_10",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_28 = NodeFirewallConfig(ip="172.18.3.20", hostname="honeypot2_11",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_29 = NodeFirewallConfig(ip="172.18.3.22", hostname="honeypot2_12",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_30 = NodeFirewallConfig(ip="172.18.3.23", hostname="honeypot2_13",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_31 = NodeFirewallConfig(ip="172.18.3.24", hostname="honeypot2_14",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_32 = NodeFirewallConfig(ip="172.18.3.25", hostname="honeypot2_15",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_33 = NodeFirewallConfig(ip="172.18.3.28", hostname="honeypot2_16",
                                 output_accept=set(), input_accept=set(), forward_accept=set(),
                                 output_drop=set(), input_drop=set(), forward_drop=set(),
                                 routes=set(), default_input="ACCEPT", default_output="ACCEPT",
                                 default_forward="ACCEPT",
                                 default_gw=None)
    node_34 = NodeFirewallConfig(ip="172.18.3.254", hostname="client1",
                                output_accept=set(["172.18.3.2", "172.18.3.3", "172.18.3.21",
...
if __name__ == '__main__':
    ...
    emulation_config = EmulationConfig(agent_ip="172.18.3.191", agent_username=constants.PYCR_ADMIN.USER,
