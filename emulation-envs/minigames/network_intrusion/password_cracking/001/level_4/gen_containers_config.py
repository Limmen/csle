...
def default_containers_config():
    containers = [
        NodeContainerConfig(name="ftp1", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4", ip="172.18.4.79"),
        NodeContainerConfig(name="hacker_kali1", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4",
                            ip="172.18.4.191"),
        NodeContainerConfig(name="honeypot1", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4",
                            ip="172.18.4.21"),
        NodeContainerConfig(name="router2", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4",
                            ip="172.18.4.10"),
        NodeContainerConfig(name="ssh1", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4",
                            ip="172.18.4.2"),
        NodeContainerConfig(name="telnet1", network="pycr_net_4", minigame="pwcrack", version="0.0.1", level="4",
                            ip="172.18.4.3")
    ]
