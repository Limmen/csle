    ...
    traffic_generators = [
        NodeTrafficConfig(ip="172.18.4.254",
                          commands=[
                              ...
                              "timeout 5 sshpass -p 'testpycruser' ssh -oStrictHostKeyChecking=no 172.18.4.2 > /dev/null 2>&1 > /dev/null 2>&1",
                              "timeout 5 curl 172.18.4.2:80 > /dev/null 2>&1",
                              "timeout 5 sshpass -p 'testpycruser' ssh -oStrictHostKeyChecking=no 172.18.4.3 > /dev/null 2>&1 > /dev/null 2>&1",
