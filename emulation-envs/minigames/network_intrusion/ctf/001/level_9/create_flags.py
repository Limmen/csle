...
def default_flags() -> FlagsConfig:
    flags = [
        NodeFlagsConfig(ip="172.18.9.79", flags=[("/tmp/flag3.txt", "flag3", "/tmp/", 3, True, 1)]),
        NodeFlagsConfig(ip="172.18.9.2", flags=[("/tmp/flag2.txt", "flag2", "/tmp/", 2, True, 1)]),
        NodeFlagsConfig(ip="172.18.9.3", flags=[("/root/flag1.txt", "flag1", "/root/", 1, True, 1)]),
        NodeFlagsConfig(ip="172.18.9.54", flags=[("/tmp/flag4.txt", "flag4", "/tmp/", 4, True, 1)]),
        NodeFlagsConfig(ip="172.18.9.61", flags=[("/root/flag5.txt", "flag5", "/root/", 5, True, 1)]),
        NodeFlagsConfig(ip="172.18.9.7", flags=[("/tmp/flag6.txt", "flag6", "/tmp/", 6, True, 1)])
    ]
