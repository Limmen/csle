...
def default_traffic_generators() -> TrafficConfig:
    traffic_generators = [
        NodeTrafficConfig(ip="172.18.1.254",
                          commands=[
                              "timeout 120 sudo nmap -sP -p- --min-rate 100000 --max-retries 1 -T5 -n  172.18.1.0/24 > /dev/null 2>&1",
...
if __name__ == '__main__':
    ...
    TrafficGenerator.create_traffic_scripts(traffic_config=traffic_config, emulation_config=emulation_config, sleep_time=2)