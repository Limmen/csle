...
def default_topology() -> Topology:
    node_1 = NodeFirewallConfig(ip="172.18.10.10",
    ...
    node_2 = NodeFirewallConfig(ip="172.18.10.2",
    ...
    node_3 = NodeFirewallConfig(ip="172.18.10.3",
                           output_accept=set(["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                              "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.19", "172.18.10.31",
                                              "172.18.10.42",
                                              "172.18.10.37", "172.18.10.82", "172.18.10.75", "172.18.10.71",
                           ...
                           forward_accept=set(), output_drop=set(), input_drop=set(), forward_drop=set(), routes=set(),
                            default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_4 = NodeFirewallConfig(ip="172.18.10.21",
    ...
    node_5 = NodeFirewallConfig(ip="172.18.10.79",
                           output_accept=set(
                           ...
                           forward_accept=set(), output_drop=set(), input_drop=set(), forward_drop=set(), routes=set(),
                           default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_6 = NodeFirewallConfig(ip="172.18.10.19",
                                output_accept=set(
                                    ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                ...
                                routes=set(),
                                default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_7 = NodeFirewallConfig(ip="172.18.10.31",
                                output_accept=set(
                                    ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                ...
                                routes=set(),
                                default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_8 = NodeFirewallConfig(ip="172.18.10.42",
                                output_accept=set(
                                    ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                ...
                                routes=set(),
                                default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_9 = NodeFirewallConfig(ip="172.18.10.37",
                                output_accept=set(
                                    ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                     "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.79", "172.18.10.42",
                                     "172.18.10.82",
                                ...
                                routes=set(),
                                default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_10 = NodeFirewallConfig(ip="172.18.10.82",
                                output_accept=set(
                                    ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                     "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.79", "172.18.10.42",
                                ...
                                routes=set(),
                                default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_11 = NodeFirewallConfig(ip="172.18.10.75",
                                 output_accept=set(
                                     ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                      "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.79", "172.18.10.42",
                                 ...
                                 routes=set(),
                                 default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_12 = NodeFirewallConfig(ip="172.18.10.71",
                                 output_accept=set(
                                     ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                      "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.79", "172.18.10.42",
                                 ...
                                 routes=set(),
                                 default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_13 = NodeFirewallConfig(ip="172.18.10.11",
                                 output_accept=set(
                                     ["172.18.10.2", "172.18.10.3", "172.18.10.21", "172.18.10.79", "172.18.10.191",
                                      "172.18.10.10", "172.18.10.1", "172.18.10.254", "172.18.10.79", "172.18.10.42",
                                 ...
                                 routes=set(),
                                 default_input="DROP", default_output="DROP", default_forward="DROP", default_gw=None)
    node_14 = NodeFirewallConfig(ip="172.18.10.191",
                       output_accept=set(["172.18.10.2", "172.18.10.3", "172.18.10.21",
    ...
    node_15 = NodeFirewallConfig(ip="172.18.10.254",
                                 output_accept=set(["172.18.10.2", "172.18.10.3", "172.18.10.21",
    ...
    node_16 = NodeFirewallConfig(ip="172.18.10.104",
                                 output_accept=set(["172.18.10.2", "172.18.10.3", "172.18.10.21",
                                                    "172.18.10.79", "172.18.10.10", "172.18.10.1",
                                                    "172.18.10.254",
                                                    "172.18.10.19", "172.18.10.31", "172.18.10.42", "172.18.10.37",
