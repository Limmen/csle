...
if __name__ == '__main__':
    ...
    with io.open("./state_to_id_6.json", 'w', encoding='utf-8') as f:
        f.write(json_str)

    json_str = json.dumps(id_to_state, indent=4, sort_keys=True, cls=NpEncoder)
    with io.open("./id_to_state_6.json", 'w', encoding='utf-8') as f:
        f.write(json_str)

    json_str = json.dumps(costs, indent=4, sort_keys=True, cls=NpEncoder)
    with io.open("./costs_6.json", 'w', encoding='utf-8') as f:
        f.write(json_str)

    json_str = json.dumps(transitions, indent=4, sort_keys=True, cls=NpEncoder)
    with io.open("./transitions_6.json", 'w', encoding='utf-8') as f:
        f.write(json_str)
