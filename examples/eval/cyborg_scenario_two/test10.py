...
if __name__ == '__main__':
    ...
    with io.open("./id_to_state_4.json", 'r') as f:
        id_to_state = json.loads(f.read())

    with io.open("./state_to_id_4.json", 'r') as f:
        state_to_id = json.loads(f.read())

    with io.open("./transitions_4.json", 'r') as f:
    ...
    with io.open("./costs_4.json", 'r') as f:
