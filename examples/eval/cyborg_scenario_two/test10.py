...
if __name__ == '__main__':
    ...
    for i in range(num_evaluations):
        ...
        while t < max_horizon:
            ...
            if len(states) > 2 and len(red_action_targets) > 2 and \
                    red_success and red_action_targets[-2] == 7 and red_action_types[-2] == 2:
                # print(f"ent2: {states[-3][3][2]}, state: {states[-1]}")
                if states[-3][3][2] == 0 and states[-3][2][2] == 0 and states[-3][1][2] == 0:
