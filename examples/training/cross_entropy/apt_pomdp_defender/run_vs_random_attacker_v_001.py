...
if __name__ == '__main__':
    ...
    simulation_name = "csle-apt-pomdp-defender-001"
    ...
    experiment_config = ExperimentConfig(
        ...
        hparams={
            ...
            agents_constants.CROSS_ENTROPY.OBJECTIVE_TYPE: HParam(
                value=ObjectiveType.MIN, name=agents_constants.CROSS_ENTROPY.OBJECTIVE_TYPE,
    ...
    input_config = AptGameConfig(
        ...
        b1=b1, env_name="csle-apt-game-pomdp-defender-v1")
    ...
    attacker_strategy = RandomPolicy(
        actions=simulation_env_config.simulation_env_input_config.attacker_strategy.actions,
        player_type=PlayerType.ATTACKER, stage_policy_tensor=pi2)
    simulation_env_config.simulation_env_input_config.attacker_strategy = attacker_strategy
    env = AptGamePomdpDefenderEnv(config=simulation_env_config.simulation_env_input_config)
