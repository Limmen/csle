...
from csle_agents.agents.dynasec_test2.dynasec_test_agent import DynaSecTestAgent2
...
if __name__ == '__main__':
    ...
    experiment_config = ExperimentConfig(
        output_dir=f"{constants.LOGGING.DEFAULT_LOG_DIR}dynasectest2_test", title="DynaSecTest2 test",
        random_seeds=[399],
        agent_type=AgentType.DYNA_SEC_TEST2,
        log_every=1,
        hparams={
            ...
            agents_constants.COMMON.EVAL_BATCH_SIZE: HParam(value=30, name=agents_constants.COMMON.EVAL_BATCH_SIZE,
