...
if __name__ == '__main__':
    ...
    experiment_config = ExperimentConfig(
        ...
        log_every=1,
        hparams={
            agents_constants.RANDOM_SEARCH.N: HParam(value=2500, name=agents_constants.RANDOM_SEARCH.N,
            ...
            agents_constants.RANDOM_SEARCH.L: HParam(value=L, name="L", descr="the number of stop actions"),
            agents_constants.COMMON.EVAL_BATCH_SIZE: HParam(value=50, name=agents_constants.COMMON.EVAL_BATCH_SIZE,
                                                            descr="number of iterations to evaluate theta"),
            agents_constants.RANDOM_SEARCH.THETA1: HParam(value=[-5] * L,
            ...
            agents_constants.RANDOM_SEARCH.OBJECTIVE_TYPE: HParam(
                value=ObjectiveType.MIN, name=agents_constants.RANDOM_SEARCH.OBJECTIVE_TYPE,
