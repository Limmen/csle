...
from csle_agents.agents.dfsp_local.dfsp_local_ppo_agent import DFSPLocalPPOAgent
...
if __name__ == '__main__':
    ...
    experiment_config = ExperimentConfig(
        ...
        hparams={
            ...
            agents_constants.COMMON.EVAL_EVERY: HParam(value=100, name=agents_constants.COMMON.EVAL_EVERY,
            ...
            agents_constants.COMMON.SAVE_EVERY: HParam(value=1000000000, name=agents_constants.COMMON.SAVE_EVERY,
    ...
    agent = DFSPLocalPPOAgent(emulation_env_config=emulation_env_config,
