...
if __name__ == '__main__':
    ...
    experiment_config = ExperimentConfig(
        output_dir=f"{constants.LOGGING.DEFAULT_LOG_DIR}differential_evolution_btr_inf",
        title="Tolerance;DE;BTR:inf",
        ...
        hparams={
            ...
            agents_constants.DIFFERENTIAL_EVOLUTION.BOUNDS: HParam(
                value=[(-5, 5) for l in range(L)], name=agents_constants.DIFFERENTIAL_EVOLUTION.BOUNDS,
