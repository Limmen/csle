...
if __name__ == '__main__':
    ...
    experiment_config = ExperimentConfig(
        ...
        hparams={
            ...
            agents_constants.T_SPSA.EPSILON: HParam(
                ...
                descr="scalar coefficient for determining gradient step sizes in T-SPSA"),
            agents_constants.T_SPSA.L: HParam(value=1, name="L", descr="the number of stop actions"),
            agents_constants.COMMON.EVAL_BATCH_SIZE: HParam(value=10, name=agents_constants.COMMON.EVAL_BATCH_SIZE,
                                                            descr="number of iterations to evaluate theta"),
            agents_constants.T_SPSA.THETA1: HParam(value=[-4], name=agents_constants.T_SPSA.THETA1,
    ...
    simulation_env_config.simulation_env_input_config.stopping_game_config.O = np.array([0, 1, 2])
    simulation_env_config.simulation_env_input_config.stopping_game_config.Z = np.array([
        [
            [
                [0.995, 0.005, 0.0],
                [0.255, 0.261, 0.484],
