...
if __name__ == '__main__':
    ...
    dataset = StatisticsDataset(
        name=name, description=descr, file_path=zip_file_path, url=url, date_added=date_added,
        num_measurements=num_measurements, num_metrics=num_metrics, size_in_gb=dir_size_uncompressed_gb,
        compressed_size_in_gb=size_compressed_gb, citation=citation, num_files=num_files, file_format=file_format,
        download_count=0, added_by=added_by, metrics=metrics, conditions=conditions, num_conditions=num_conditions)
