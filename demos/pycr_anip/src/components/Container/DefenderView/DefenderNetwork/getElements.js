...
const getEdges = (edgeType = 'smoothstep') => {
    return [
        ...
        {id: 'e_gateway_n2', source: 'gateway', className: "nodrag", target: 'n2', type: edgeType, animated: true},
        {id: 'e_gateway_n3', source: 'gateway', className: "nodrag", target: 'n3', type: edgeType, animated: true},
        {id: 'e_gateway_n4', source: 'gateway', className: "nodrag", target: 'n4', type: edgeType, animated: true},
        {id: 'e_gateway_n5', source: 'gateway', className: "nodrag", target: 'n5', type: edgeType, animated: true},
        {id: 'e_gateway_n6', source: 'gateway', className: "nodrag", target: 'n6', type: edgeType, animated: true},
        {id: 'e_gateway_n7', source: 'gateway', className: "nodrag", target: 'n7', type: edgeType, animated: true},
        {id: 'e_gateway_n8', source: 'gateway', className: "nodrag", target: 'n8', type: edgeType, animated: true},
        {id: 'e_gateway_n9', source: 'gateway', className: "nodrag", target: 'n9', type: edgeType, animated: true},
        {id: 'e_gateway_n10', source: 'gateway', className: "nodrag", target: 'n10', type: edgeType, animated: true},
        {id: 'e_gateway_n11', source: 'gateway', className: "nodrag", target: 'n11', type: edgeType, animated: true},

        //Gateway to IDS
        {id: 'e_gateway_ids', source: 'gateway', className: "nodrag", target: 'ids', type: edgeType, animated: true},

        //N1 to switch
        {id: 'e_n1_switch1', source: 'n2', className: "nodrag", target: 'switch1', type: edgeType, animated: true},

        //switch1 to N12
        {id: 'e_switch1_n12', source: 'switch1', className: "nodrag", target: 'n12', type: edgeType, animated: true},

        //N12 to N13-16
        {id: 'e_n12_n13', source: 'n12', className: "nodrag", target: 'n13', type: edgeType, animated: true},
        {id: 'e_n12_n14', source: 'n12', className: "nodrag", target: 'n14', type: edgeType, animated: true},
        {id: 'e_n12_n15', source: 'n12', className: "nodrag", target: 'n15', type: edgeType, animated: true},
        {id: 'e_n12_n16', source: 'n12', className: "nodrag", target: 'n16', type: edgeType, animated: true},

        //N4 to switch2
        {id: 'e_n14_switch2', source: 'n4', className: "nodrag", target: 'switch2', type: edgeType, animated: true},

        //switch2 to n17
        {id: 'e_switch2_n17', source: 'switch2', className: "nodrag", target: 'n17', type: edgeType, animated: true},

        //n17 to n18
        {id: 'e_n17_n18', source: 'n17', className: "nodrag", target: 'n18', type: edgeType, animated: true},

        //n17 to switch3
        {id: 'e_n17_switch3', source: 'n17', className: "nodrag", target: 'switch3', type: edgeType, animated: true},

        //switch3 to n19-24
        {id: 'e_switch3_n19', source: 'switch3', className: "nodrag", target: 'n19', type: edgeType, animated: true},
        {id: 'e_switch3_n20', source: 'switch3', className: "nodrag", target: 'n20', type: edgeType, animated: true},
        {id: 'e_switch3_n21', source: 'switch3', className: "nodrag", target: 'n21', type: edgeType, animated: true},
        {id: 'e_switch3_n22', source: 'switch3', className: "nodrag", target: 'n22', type: edgeType, animated: true},
        {id: 'e_switch3_n23', source: 'switch3', className: "nodrag", target: 'n23', type: edgeType, animated: true},
        {id: 'e_switch3_n24', source: 'switch3', className: "nodrag", target: 'n24', type: edgeType, animated: true},

        //n18 to switch4
        {id: 'e_n18_switch4', source: 'n18', className: "nodrag", target: 'switch4', type: edgeType, animated: true},

        //switch4 to n25-26
        {id: 'e_switch4_n25', source: 'switch4', className: "nodrag", target: 'n25', type: edgeType, animated: true},
        {id: 'e_switch4_n26', source: 'switch4', className: "nodrag", target: 'n26', type: edgeType, animated: true},

        //n26 to switch6
        {id: 'e_n26_switch6', source: 'n26', className: "nodrag", target: 'switch6', type: edgeType, animated: true},

        //n25 to switch5
        {id: 'e_n25_switch5', source: 'n25', className: "nodrag", target: 'switch5', type: edgeType, animated: true},

        //switch5 to n27
        {id: 'e_switch5_n27', source: 'switch5', className: "nodrag", target: 'n27', type: edgeType, animated: true},

        //switch6 to n28-31
        {id: 'e_switch6_n28', source: 'switch6', className: "nodrag", target: 'n28', type: edgeType, animated: true},
        {id: 'e_switch6_n29', source: 'switch6', className: "nodrag", target: 'n29', type: edgeType, animated: true},
        {id: 'e_switch6_n30', source: 'switch6', className: "nodrag", target: 'n30', type: edgeType, animated: true},
        {id: 'e_switch6_n31', source: 'switch6', className: "nodrag", target: 'n31', type: edgeType, animated: true},

        //n28-31, n7, switch5, n25, n26 to defender
        {id: 'e_n31_defender', source: 'n31', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n30_defender', source: 'n30', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n29_defender', source: 'n29', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n28_defender', source: 'n28', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n27_defender', source: 'n27', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n26_defender', source: 'n26', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_n25_defender', source: 'n25', className: "nodrag", target: 'defender', type: edgeType, animated: true},
        {id: 'e_switch5_defender', source: 'switch5', className: "nodrag", target: 'defender', type: edgeType, animated: true},
