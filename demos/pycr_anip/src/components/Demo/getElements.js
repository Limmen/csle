...
const getNodes = (base_position = {x: 0, y: 0}) => {
    ...
    return [
        ...
        {
            id: 'attacker_notstarted',
            type: 'attackerNotStarted',
            className: "nodrag",
            data: {label: 'attacker', text:'Attacker'},
            position: {x: attackerBaseX, y: attackerBaseY},
            isHidden : false
        ...
        },
        {
            ...
            type: 'firewall',
            className: "nodrag",
            data: {label: 'firewall', text:'Firewall'},
            position: {x: gatewayBaseX + appServerHorizontalPadding*0.08, y: gatewayBaseY - appServerVerticalPadding*0.06},
            isHidden : false
        },
        {
            id: 'ids',
        ...
        {
            id: 'n2_notfound',
            type: 'applicationServerNotFound',
            className: "nodrag",
            data: {label: 'N2', text:'N2'},
            position: {x: gatewayBaseX-4*appServerHorizontalPadding, y: appServerBaseY},
            isHidden : false
...
const getEdges = (edgeType = 'smoothstep') => {
    return [
        ...
        //Gateway to first layer
        {id: 'e_gateway_n2_notfound', source: 'gateway', className: "nodrag", target: 'n2_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n3_notfound', source: 'gateway', className: "nodrag", target: 'n3_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n4_notfound', source: 'gateway', className: "nodrag", target: 'n4_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n5_notfound', source: 'gateway', className: "nodrag", target: 'n5_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n6_notfound', source: 'gateway', className: "nodrag", target: 'n6_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n7_notfound', source: 'gateway', className: "nodrag", target: 'n7_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n8_notfound', source: 'gateway', className: "nodrag", target: 'n8_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n9_notfound', source: 'gateway', className: "nodrag", target: 'n9_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n10_notfound', source: 'gateway', className: "nodrag", target: 'n10_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_gateway_n11_notfound', source: 'gateway', className: "nodrag", target: 'n11_notfound', type: edgeType, animated: true, isHidden: false},

        //N1 to switch
        {id: 'e_n1_switch1_notfound', source: 'n2_notfound', className: "nodrag", target: 'switch1_notfound', type: edgeType, animated: true, isHidden: false},

        //switch1 to N12
        {id: 'e_switch1_n12_notfound', source: 'switch1_notfound', className: "nodrag", target: 'n12_notfound', type: edgeType, animated: true, isHidden: false},

        //N12 to N13-16
        {id: 'e_n12_n13_notfound', source: 'n12_notfound', className: "nodrag", target: 'n13_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n12_n14_notfound', source: 'n12_notfound', className: "nodrag", target: 'n14_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n12_n15_notfound', source: 'n12_notfound', className: "nodrag", target: 'n15_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n12_n16_notfound', source: 'n12_notfound', className: "nodrag", target: 'n16_notfound', type: edgeType, animated: true, isHidden: false},

        //N4 to switch2
        {id: 'e_n14_switch2_notfound', source: 'n4_notfound', className: "nodrag", target: 'switch2_notfound', type: edgeType, animated: true, isHidden: false},

        //switch2 to n17
        {id: 'e_switch2_n17_notfound', source: 'switch2_notfound', className: "nodrag", target: 'n17_notfound', type: edgeType, animated: true, isHidden: false},

        //n17 to n18
        {id: 'e_n17_n18_notfound', source: 'n17_notfound', className: "nodrag", target: 'n18_notfound', type: edgeType, animated: true, isHidden: false},

        //n17 to switch3
        {id: 'e_n17_switch3_notfound', source: 'n17_notfound', className: "nodrag", target: 'switch3_notfound', type: edgeType, animated: true, isHidden: false},

        //switch3 to n19-24
        {id: 'e_switch3_n19_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n19_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch3_n20_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n20_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch3_n21_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n21_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch3_n22_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n22_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch3_n23_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n23_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch3_n24_notfound', source: 'switch3_notfound', className: "nodrag", target: 'n24_notfound', type: edgeType, animated: true, isHidden: false},

        //n18 to switch4
        {id: 'e_n18_switch4_notfound', source: 'n18', className: "nodrag", target: 'switch4_notfound', type: edgeType, animated: true, isHidden: false},

        //switch4 to n25-26
        {id: 'e_switch4_n25_notfound', source: 'switch4_notfound', className: "nodrag", target: 'n25_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch4_n26_notfound', source: 'switch4_notfound', className: "nodrag", target: 'n26_notfound', type: edgeType, animated: true, isHidden: false},

        //n26 to switch6
        {id: 'e_n26_switch6_notfound', source: 'n26_notfound', className: "nodrag", target: 'switch6_notfound', type: edgeType, animated: true, isHidden: false},

        //n25 to switch5
        {id: 'e_n25_switch5_notfound', source: 'n25_notfound', className: "nodrag", target: 'switch5_notfound', type: edgeType, animated: true, isHidden: false},

        //switch5 to n27
        {id: 'e_switch5_n27_notfound', source: 'switch5_notfound', className: "nodrag", target: 'n27_notfound', type: edgeType, animated: true, isHidden: false},

        //switch6 to n28-31
        {id: 'e_switch6_n28_notfound', source: 'switch6_notfound', className: "nodrag", target: 'n28_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch6_n29_notfound', source: 'switch6_notfound', className: "nodrag", target: 'n29_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch6_n30_notfound', source: 'switch6_notfound', className: "nodrag", target: 'n30_notfound', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch6_n31_notfound', source: 'switch6_notfound', className: "nodrag", target: 'n31_notfound', type: edgeType, animated: true, isHidden: false},

        //n28-31, n7, switch5, n25, n26 to defender
        {id: 'e_n31_defender_notfound', source: 'n31_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n30_defender_notfound', source: 'n30_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n29_defender_notfound', source: 'n29_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n28_defender_notfound', source: 'n28_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n27_defender_notfound', source: 'n27_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n26_defender_notfound', source: 'n26_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_n25_defender_notfound', source: 'n25_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
        {id: 'e_switch5_defender_notfound', source: 'switch5_notfound', className: "nodrag", target: 'defender', type: edgeType, animated: true, isHidden: false},
