...
<p class="captionFig">
Listing 122: Command to install the Python build tool.
</p>
...
<p class="captionFig">
Listing 124: Command to install `twine`.
</p>
...
<p class="captionFig">
Listing 125: Command to install `flake8`.
</p>
...
<p class="captionFig">
Listing 126: Command to install `mypy`.
</p>
...
<p class="captionFig">
Listing 127: Command to install `pytest` and `mock`.
</p>
...
<p class="captionFig">
Listing 128: Commands to install Ruby and its bundler.
</p>
...
<p class="captionFig">
Listing 129: Commands to install `sphinx`.
</p>
...
<p class="captionFig">
Listing 130: Command to install `tox`.
</p>
