...
<p class="captionFig">
Listing 113: Command to install the Python build tool.
</p>
...
<p class="captionFig">
Listing 114: Command to install the Python build tool.
</p>
...
<p class="captionFig">
Listing 115: Command to install `twine`.
</p>
...
<p class="captionFig">
Listing 116: Command to install `flake8`.
</p>
...
<p class="captionFig">
Listing 117: Command to install `mypy`.
</p>
...
<p class="captionFig">
Listing 118: Command to install `pytest` and `mock`.
</p>
...
<p class="captionFig">
Listing 119: Commands to install Ruby and its bundler.
</p>
...
<p class="captionFig">
Listing 120: Commands to install `sphinx`.
</p>
...
<p class="captionFig">
Listing 121: Command to install `tox`.
</p>
