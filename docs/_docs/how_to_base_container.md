...
1. Create a sub-directory with the name `my_container` in the following directory:
   ...
   ```
   <p class="captionFig">
   Listing 144: Directory with base Docker images.
   </p>
2. Add a Dockerfile to the following directory:
    ...
    ```
   <p class="captionFig">
   Listing 145: Directory with the Dockerfile of a container with the name `my_container`.
   </p>
3. Add build and push instructions to the following Makefile:
    ...
    ```
   <p class="captionFig">
   Listing 146: Makefile for base Docker images.
   </p>
4. Update the following README file:
     ...
     ```
   <p class="captionFig">
   Listing 147: README file for base Docker images.
   </p>
5. Build and push the image to DockerHub by running the commands:
    ...
    ```
   <p class="captionFig">
   Listing 148: Commands to build and push the base Docker image `my_container` to DockerHub.
   </p>
