...
<p class="captionFig">
Listing 85: Command to list all information about CSLE.
</p>
...
<p class="captionFig">
Listing 86: Command to start an execution of the emulation configuration csle-level9-010.
</p>
...
<p class="captionFig">
Listing 87: Command to start monitoring systems and the management system of CSLE.
</p>
...
<p class="captionFig">
Listing 88: Command to run the Proximal Policy Optimization (PPO) algorithm for learning defender strategies in CSLE.
</p>