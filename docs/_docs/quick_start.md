...
<p class="captionFig">
Listing 61: Command to list all information about CSLE.
</p>
...
<p class="captionFig">
Listing 63: Command to start monitoring systems and the management system of CSLE.
</p>
...
<p class="captionFig">
Listing 64: Command to run the Proximal Policy Optimization (PPO) algorithm for learning defender strategies in CSLE.
</p>