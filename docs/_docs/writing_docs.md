...
- Live <a href="ttps://kim-hammar.github.io/csle//">web documentation</a>. This documentation is generated with Ruby. The source files are located at `csle/docs`. This documentation is updated automatically on every code commit to the project. To generate the web documentation manually, run the command:
   ```bash
   bundle exec Jekyll serve
   ```
  <p class="captionFig">
  Listing 133: Command to generate the web documentation at <a href="https://kim-hammar.github.io/csle//">https://kim-hammar.github.io/csle//</a>.
  </p>
