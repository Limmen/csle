...
```
<p class="captionFig">
Listing 174: Commands for pulling the latest code changes from the master branch.
</p>
...
```
<p class="captionFig">
Listing 175: Commands for resetting the local version of the code to the upstream version. 
...
```
<p class="captionFig">
Listing 176: Command for creating a new branch with name `mybranchname`.
</p>
...
```
<p class="captionFig">
Listing 177: Commands committing new code changes.
</p>
...
```
<p class="captionFig">
Listing 178: Command for pushing the branch `mybranchname` to GitHub.
</p>
...
```
<p class="captionFig">
Listing 179: Commands for (1) switching to the master branch; (2) pulling the latest changes; and (3) 
...
```
<p class="captionFig">
Listing 180: Command for viewing git commits.
</p>