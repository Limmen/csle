...
1. Do the necessary code changes to the monitoring agent by editing the files in the directory:
    ...
    ```
   <p class="captionFig">
   Listing 165: Directory with source code of the monitoring agents in CSLE.
   </p>
2. Update the gRPC API by editing the protocol-buffer files in the directory:
    ...
    ```
   <p class="captionFig">
   Listing 166: Directory with protocol buffers for the monitoring agents in CSLE.
   </p>
3. Regenerate the gRPC Python files by running the commands:
    ...
    ```
   <p class="captionFig">
   Listing 167: Commands to generate gRPC Python files from protobuf files.
   </p>
