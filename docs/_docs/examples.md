...
<p class="captionFig">
Listing 80: Example of collecting attack and system traces with CSLE.
</p>
...
<p class="captionFig">
Listing 81: Example of system identification through expectation maximization with CSLE.
</p>
...
<p class="captionFig">
Listing 82: Example of strategy optimization through the Proximal Policy Optimization (PPO) reinforcement learning algorithm in CSLE.
</p>
...
<p class="captionFig">
Listing 83: Example of evaluating learned security strategies in the emulation system of CSLE.
</p>
