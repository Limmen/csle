...
/**
 * Component containing a plot showing the number of OSSEC alerts over time
 */
const OssecAlertsChart = React.memo((props) => {
        const width = 500
        const height = 200
        const margin = {
            top: 10,
        ...
        if (props.stats !== undefined && props.stats.length > 0) {
            const data = props.stats.map((alert_counters, index) => {
                return {
                    ...
                    "Alerts weighted by level Δz": parseInt(alert_counters.alerts_weighted_by_level),
                }
            })
            ...
            return (
                <ResponsiveContainer width='100%' height={300}>
                    ...
                    >
                        ...
                        <Line animation={props.animation} type="monotone" dataKey="Alerts weighted by level Δz"
