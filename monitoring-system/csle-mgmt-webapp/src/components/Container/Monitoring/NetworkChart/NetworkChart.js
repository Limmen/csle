...
const NetworkChart = React.memo((props) => {
        ...
        if (props.stats !== undefined && props.stats.length > 0) {
            const data = props.stats.map((docker_stats, index) => {
                return {
                    "t": (index + 1),
                    "Transmitted MB": parseInt(docker_stats.net_tx),
                    "Received MB": parseInt(docker_stats.net_rx),
                }
            })
                ...
                <ResponsiveContainer width='100%' height={300}>
                    ...
                    >
                        <text x={650} y={20} fill="black" textAnchor="middle" dominantBaseline="central">
                            <tspan fontSize="22">Avg network load</tspan>
                        </text>
                        ...
                        <YAxis type="number">
                            <Label angle={270} value="Mega bytes" offset={0} position="insideLeft" className="largeFont"
                                   dy={50}/>
                        </YAxis>
                        <Tooltip/>
                        ...
                        <Line animation={props.animation} type="monotone" dataKey="Received MB"
