...
const BlockIOChart = React.memo((props) => {
        ...
        if (props.stats !== undefined && props.stats.length > 0) {
            const data = props.stats.map((docker_stats, index) => {
                return {
                    "t": (index + 1),
                    "Read blocks": parseInt(docker_stats.blk_read),
                    "Written blocks": parseInt(docker_stats.blk_write),
                }
            })
                ...
                <ResponsiveContainer width='100%' height={300}>
                    ...
                    >
                        <text x={500} y={20} fill="black" textAnchor="middle" dominantBaseline="central">
                            <tspan fontSize="15">Filesystem I/O</tspan>
                        </text>
                        ...
                        <YAxis type="number">
                            <Label angle={270} value="# Blocks" offset={0} position="insideLeft" className="largeFont"
                                   dy={50}/>
                        </YAxis>
                        <Tooltip/>
                        ...
                        <Line animation={props.animation} type="monotone" dataKey="Written blocks"
