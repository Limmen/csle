...
def default_config() -> ClientConfig:
    ...
    cluster_configs = [
        ...
        ClusterConfig(agent_ip=containers_configs[idx + 3].agent_ip, agent_username="agent", agent_pw="agent",
                      ...
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 4].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
                      port_forward_next_port=4001 + (idx + 4) * 150,
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 5].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
                      port_forward_next_port=4001 + (idx + 5) * 150,
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 6].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
                      port_forward_next_port=4001 + (idx + 6) * 150,
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 7].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
                      port_forward_next_port=4001 + (idx + 7) * 150,
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 8].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
                      port_forward_next_port=4001 + (idx + 8) * 150,
                      warmup=True, warmup_iterations=500),
        ClusterConfig(agent_ip=containers_configs[idx + 9].agent_ip, agent_username="agent", agent_pw="agent",
                      server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                      server_username="kim", server_ip="172.31.212.92",
