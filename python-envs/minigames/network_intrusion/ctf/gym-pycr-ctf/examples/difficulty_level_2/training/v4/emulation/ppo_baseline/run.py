...
def default_config() -> ClientConfig:
    ...
    env_name = "pycr-ctf-level-2-emulation-v4"
    #env_name = "pycr-ctf-level-2-emulation-costs-v4"
    ...
    client_config = ClientConfig(env_name=env_name, agent_config=agent_config,
                                 ...
                                 random_seed=499, emulation_config=emulation_config, mode=RunnerMode.TRAIN_ATTACKER.value)
