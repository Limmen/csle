...
def test_all():
    #test_env("pycr-ctf-level-7-cluster-v1", num_steps=1000000000)
    #test_env("pycr-ctf-level-7-cluster-v2", num_steps=1000000000)
    #test_env("pycr-ctf-level-7-cluster-v3", num_steps=1000000000)
    test_env("pycr-ctf-level-7-cluster-v1", num_steps=1000000000)
