...
def default_config() -> ClientConfig:
    ...
    #env_name = "pycr-ctf-level-1-emulation-v4"
    env_name = "pycr-ctf-level-1-emulation-costs-v4"
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_1 v4 emulation"
