...
def default_config() -> ClientConfig:
    ...
    agent_config = AgentConfig(gamma=0.99, alpha=0.0005, epsilon=1, render=False, eval_sleep=0.0,
                               ...
                               load_path="/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_1/training/v2/cluster/ppo_baseline/results/data/399/1603222971.1888826_policy_network.zip"
                               )
    env_name = "pycr-ctf-level-1-cluster-v1"
