...
def test_all():
    #test_env("pycr-ctf-level-10-emulation-v1", num_steps=1000000000)
    #test_env("pycr-ctf-level-10-emulation-v2", num_steps=1000000000)
    #test_env("pycr-ctf-level-10-emulation-v3", num_steps=1000000000)
    test_env("pycr-ctf-level-10-emulation-v1", num_steps=1000000000)
