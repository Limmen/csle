...
def plot_train(avg_train_rewards_data_v1, avg_train_rewards_means_v1, avg_train_rewards_stds_v1, avg_train_steps_data_v1,
    ...
    plotting_util_defender.plot_rewards_defender_2(
        ...
        markevery=3, optimal_reward=100, sample_step=1, plot_opt=True, iterations_per_step=10
    )
    ...
    plotting_util_defender.plot_caught_stopped_intruded_2(
        ...
        markevery=3, optimal_reward=1, sample_step=1, plot_opt=True, iterations_per_step=10
    )
    ...
    plotting_util_defender.plot_costs_attacker(
        ...
        markevery=3, optimal_reward=450, sample_step=1, plot_opt=False, iterations_per_step=10
    )
...
if __name__ == '__main__':
    base_path = "/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_9/training/v5/generated_simulation/defender/results_backup/data/"
