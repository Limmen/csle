...
def plot_train(
    ...
    plotting_util_defender.plot_defender_simulation_emulation_tnsm_21_multiple_attackers(
        ...
        optimal_steps_data_simulation_novice_attacker = avg_train_i_steps_data_novice_attacker[0:max_iter],
        optimal_steps_means_simulation_novice_attacker = avg_train_i_steps_means_novice_attacker[0:max_iter],
        optimal_steps_stds_simulation_novice_attacker = avg_train_i_steps_stds_novice_attacker[0:max_iter],
        ...
        optimal_steps_data_emulation_novice_attacker=avg_eval_2_i_steps_data_novice_attacker[0:max_iter],
        optimal_steps_means_emulation_novice_attacker=avg_eval_2_i_steps_means_novice_attacker[0:max_iter],
        optimal_steps_stds_emulation_novice_attacker=avg_eval_2_i_steps_stds_novice_attacker[0:max_iter],
        ...
        optimal_steps_data_simulation_experienced_attacker=avg_train_i_steps_data_experienced_attacker[0:max_iter],
        optimal_steps_means_simulation_experienced_attacker=avg_train_i_steps_means_experienced_attacker[0:max_iter],
        optimal_steps_stds_simulation_experienced_attacker=avg_train_i_steps_stds_experienced_attacker[0:max_iter],
        ...
        optimal_steps_data_emulation_experienced_attacker=avg_eval_2_i_steps_data_experienced_attacker[0:max_iter],
        optimal_steps_means_emulation_experienced_attacker=avg_eval_2_i_steps_means_experienced_attacker[0:max_iter],
        optimal_steps_stds_emulation_experienced_attacker=avg_eval_2_i_steps_stds_experienced_attacker[0:max_iter],
        ...
        optimal_steps_data_simulation_expert_attacker=avg_train_i_steps_data_expert_attacker[0:max_iter],
        optimal_steps_means_simulation_expert_attacker=avg_train_i_steps_means_expert_attacker[0:max_iter],
        optimal_steps_stds_simulation_expert_attacker=avg_train_i_steps_stds_expert_attacker[0:max_iter],
        ...
        optimal_steps_data_emulation_expert_attacker=avg_eval_2_i_steps_data_expert_attacker[0:max_iter],
        optimal_steps_means_emulation_expert_attacker=avg_eval_2_i_steps_means_expert_attacker[0:max_iter],
    ...
    plotting_util_defender.plot_defender_emulation_with_baselines_tnsm_21(
        avg_rewards_data_emulation_novice_attacker=avg_eval_2_rewards_data_novice_attacker[0:max_iter],
        avg_rewards_means_emulation_novice_attacker=avg_eval_2_rewards_means_novice_attacker[0:max_iter],
        avg_rewards_stds_emulation_novice_attacker=avg_eval_2_rewards_stds_novice_attacker[0:max_iter],
        avg_steps_data_emulation_novice_attacker=avg_eval_2_steps_data_novice_attacker[0:max_iter],
...
if __name__ == '__main__':
    ...
    base_path_1 = "/Users/kimham/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_9/20_aug/results_experienced_attacker_128_neurons_2_hidden_layers_12k_batch/data/"
    avg_train_rewards_data_experienced_attacker, avg_train_rewards_means_experienced_attacker, \
    avg_train_rewards_stds_experienced_attacker, \
    avg_train_steps_data_experienced_attacker, avg_train_steps_means_experienced_attacker, \
    avg_train_steps_stds_experienced_attacker, \
    ...
    base_path_1 = "/Users/kimham/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_9/20_aug/results_expert_attacker_128_neurons_2_hidden_layers_12k_batch/data/"
    avg_train_rewards_data_expert_attacker, avg_train_rewards_means_expert_attacker, \
    avg_train_rewards_stds_expert_attacker, \
    avg_train_steps_data_expert_attacker, avg_train_steps_means_expert_attacker, \
    avg_train_steps_stds_expert_attacker, \
