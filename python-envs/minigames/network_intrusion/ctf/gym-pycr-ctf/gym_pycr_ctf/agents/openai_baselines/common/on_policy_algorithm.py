            ...
            if dones.any():
                for i in range(len(dones)):
                    if dones[i]:
                        ...
                        rollout_data_dto.episode_snort_severe_baseline_first_stop_step.append(infos[i][constants.INFO_DICT.SNORT_SEVERE_BASELINE_FIRST_STOP_STEP])
                        rollout_data_dto.episode_snort_warning_baseline_first_stop_step.append(infos[i][constants.INFO_DICT.SNORT_WARNING_BASELINE_FIRST_STOP_STEP])
                        rollout_data_dto.episode_snort_critical_baseline_first_stop_step.append(infos[i][constants.INFO_DICT.SNORT_CRITICAL_BASELINE_FIRST_STOP_STEP])
                        rollout_data_dto.episode_var_log_baseline_first_stop_step.append(infos[i][constants.INFO_DICT.VAR_LOG_BASELINE_FIRST_STOP_STEP])
                        rollout_data_dto.episode_step_baseline_first_stop_step.append(infos[i][constants.INFO_DICT.STEP_BASELINE_FIRST_STOP_STEP])
                        rollout_data_dto.episode_snort_severe_baseline_second_stop_step.append(infos[i][constants.INFO_DICT.SNORT_SEVERE_BASELINE_SECOND_STOP_STEP])
                        rollout_data_dto.episode_snort_warning_baseline_second_stop_step.append(infos[i][constants.INFO_DICT.SNORT_WARNING_BASELINE_SECOND_STOP_STEP])
                        rollout_data_dto.episode_snort_critical_baseline_second_stop_step.append(infos[i][constants.INFO_DICT.SNORT_CRITICAL_BASELINE_SECOND_STOP_STEP])
                        rollout_data_dto.episode_var_log_baseline_second_stop_step.append(infos[i][constants.INFO_DICT.VAR_LOG_BASELINE_SECOND_STOP_STEP])
                        rollout_data_dto.episode_step_baseline_second_stop_step.append(infos[i][constants.INFO_DICT.STEP_BASELINE_SECOND_STOP_STEP])
                        rollout_data_dto.episode_snort_severe_baseline_third_stop_step.append(infos[i][constants.INFO_DICT.SNORT_SEVERE_BASELINE_THIRD_STOP_STEP])
                        rollout_data_dto.episode_snort_warning_baseline_third_stop_step.append(infos[i][constants.INFO_DICT.SNORT_WARNING_BASELINE_THIRD_STOP_STEP])
                        rollout_data_dto.episode_snort_critical_baseline_third_stop_step.append(infos[i][constants.INFO_DICT.SNORT_CRITICAL_BASELINE_THIRD_STOP_STEP])
                        rollout_data_dto.episode_var_log_baseline_third_stop_step.append(infos[i][constants.INFO_DICT.VAR_LOG_BASELINE_THIRD_STOP_STEP])
                        rollout_data_dto.episode_step_baseline_third_stop_step.append(infos[i][constants.INFO_DICT.STEP_BASELINE_THIRD_STOP_STEP])
                        rollout_data_dto.episode_snort_severe_baseline_fourth_stop_step.append(infos[i][constants.INFO_DICT.SNORT_SEVERE_BASELINE_FOURTH_STOP_STEP])
                        rollout_data_dto.episode_snort_warning_baseline_fourth_stop_step.append(infos[i][constants.INFO_DICT.SNORT_WARNING_BASELINE_FOURTH_STOP_STEP])
                        rollout_data_dto.episode_snort_critical_baseline_fourth_stop_step.append(infos[i][constants.INFO_DICT.SNORT_CRITICAL_BASELINE_FOURTH_STOP_STEP])
                        rollout_data_dto.episode_var_log_baseline_fourth_stop_step.append(infos[i][constants.INFO_DICT.VAR_LOG_BASELINE_FOURTH_STOP_STEP])
                        rollout_data_dto.episode_step_baseline_fourth_stop_step.append(infos[i][constants.INFO_DICT.STEP_BASELINE_FOURTH_STOP_STEP])
                        rollout_data_dto.episode_snort_severe_baseline_stops_remaining.append(infos[i][constants.INFO_DICT.SNORT_SEVERE_BASELINE_STOPS_REMAINING])
                        rollout_data_dto.episode_snort_warning_baseline_stops_remaining.append(infos[i][constants.INFO_DICT.SNORT_WARNING_BASELINE_STOPS_REMAINING])
