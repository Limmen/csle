...
from gym_pycr_ctf.dao.action.action import ActionOutcome
...
class ShellActions:
    ...
    @staticmethod
    def CVE_2010_0426_PRIV_ESC(index: int) -> Action:
        """
        ...
        :return: the action
        """
        id = ActionId.CVE_2010_0426_PRIV_ESC
    ...
    @staticmethod
    def CVE_2015_5602_PRIV_ESC(index: int) -> Action:
        """
