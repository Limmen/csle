...
class ActionCosts:
    ...
    def add_cost(self, action_id : AttackerActionId, ip: str, cost: float) -> None:
        """
    ...
    def get_cost(self, action_id : AttackerActionId, ip: str) -> int:
        """
    ...
    def find_add_cost(self, action_id: AttackerActionId, ip: str, cost: float, user: str, service: str) -> None:
        """
    ...
    def find_get_cost(self, action_id: AttackerActionId, ip: str, user: str, service: str) -> float:
        """
    ...
    def find_exists(self, action_id: AttackerActionId, ip: str, user: str, service: str) -> bool:
        """
    ...
    def service_add_cost(self, action_id: AttackerActionId, ip: str, cost: float) -> None:
        """
        Adds a cost for a given action id and ip
    ...
    def service_get_cost(self, action_id: AttackerActionId, ip: str) -> float:
        """
    ...
    def service_exists(self, action_id: AttackerActionId, ip: str) -> bool:
        """
    ...
    def install_add_cost(self, action_id: AttackerActionId, ip: str, cost: float, user: str) -> None:
        """
    ...
    def install_get_cost(self, action_id: AttackerActionId, ip: str, user: str) -> float:
        """
    ...
    def install_exists(self, action_id: AttackerActionId, ip: str, user: str) -> bool:
        """
    ...
    def pivot_scan_add_cost(self, action_id: AttackerActionId, ip: str, cost: float, user: str, target_ip: str) -> None:
        """
    ...
    def pivot_scan_get_cost(self, action_id: AttackerActionId, ip: str, user: str, target_ip: str) -> float:
        """
