...
class PyCrCTFLevel2V2:
    """
    V2 configuration of level 2 of the PyCrCTF environment.
    """
    ...
    def actions_conf(num_nodes: int, subnet_mask: str, hacker_ip: str = None) -> AttackerActionConfig:
        ...
        nikto_action_ids = []
        masscan_action_ids = []
        action_config = AttackerActionConfig(num_indices=num_nodes + 1, actions=attack_actions, nmap_action_ids=nmap_action_ids,
    ...
    def env_config(network_conf : NetworkConfig, attacker_action_conf: AttackerActionConfig,
        ...
        env_config = EnvConfig(network_conf=network_conf, attacker_action_conf=attacker_action_conf,
                               ...
                               attacker_num_sh_obs=3, num_nodes = PyCrCTFLevel2Base.num_nodes(),
