...
from gym_pycr_ctf.envs_model.config.level_6 import PyCrCTFLevel6Base
...
class PyCrCTFLevel6V2:
    """
    V2 configuration of level 6 of the PyCrCTF environment.
    """
    ...
    def env_config(network_conf : NetworkConfig, attacker_action_conf: AttackerActionConfig,
        ...
        env_config = EnvConfig(network_conf=network_conf, attacker_action_conf=attacker_action_conf,
                               ...
                               hacker_ip=PyCrCTFLevel6Base.hacker_ip(), state_type=StateType.ESSENTIAL,
