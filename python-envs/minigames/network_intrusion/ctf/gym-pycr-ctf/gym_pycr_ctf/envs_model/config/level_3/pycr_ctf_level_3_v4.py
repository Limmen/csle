...
class PyCrCTFLevel3V4:
    """
    V4 configuration of level 3 of the PyCrCTF environment.
    """
    ...
    def attacker_actions_conf(num_nodes: int, subnet_mask: str, hacker_ip: str) -> AttackerActionConfig:
        ...
        attacker_action_conf = AttackerActionConfig(num_indices=num_nodes, actions=attacker_actions,
