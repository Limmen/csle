...
class ActionId(Enum):
    ...
    CVE_2010_0426_EXPLOIT = 59
    CVE_2015_5602_EXPLOIT = 60

    TCP_SYN_STEALTH_SCAN_ALL = 61
    PING_SCAN_ALL = 62
    UDP_PORT_SCAN_ALL = 63
    TCP_CON_NON_STEALTH_SCAN_ALL = 64
    TCP_FIN_SCAN_ALL = 65
    TCP_NULL_SCAN_ALL = 66
    TCP_XMAS_TREE_SCAN_ALL = 67
    OS_DETECTION_SCAN_ALL = 68
    VULSCAN_ALL = 69
    NMAP_VULNERS_ALL = 70
    TELNET_SAME_USER_PASS_DICTIONARY_ALL = 71
    SSH_SAME_USER_PASS_DICTIONARY_ALL = 72
    FTP_SAME_USER_PASS_DICTIONARY_ALL = 73
    CASSANDRA_SAME_USER_PASS_DICTIONARY_ALL = 74
    IRC_SAME_USER_PASS_DICTIONARY_ALL = 74
    MONGO_SAME_USER_PASS_DICTIONARY_ALL = 76
    MYSQL_SAME_USER_PASS_DICTIONARY_ALL = 77
    SMTP_SAME_USER_PASS_DICTIONARY_ALL = 78
    POSTGRES_SAME_USER_PASS_DICTIONARY_ALL = 79
    FIREWALK_ALL = 80
    HTTP_ENUM_ALL = 81
    HTTP_GREP_ALL = 82
    FINGER_ALL = 83