...
class NmapPort:
    ...
    def __str__(self):
        return "port_id:{}, protocol:{}, status:{}, service_name:{}, http_enum:{}, http_grep:{}".format(
            self.port_id, self.protocol, self.status, self.service_name, self.http_enum, self.http_grep)
