...
class PyCrPwCrackMediumV4:
    ...
    def env_config(network_conf : NetworkConfig, action_conf: ActionConfig, cluster_conf: ClusterConfig,
        ...
        env_config.flag_found_reward_mult = 5
        env_config.shell_access_found_reward_mult = 5
        env_config.new_tools_installed_reward_mult = 5
        ...
        env_config.new_login_reward_mult = 5
        env_config.machine_found_reward_mult = 0
        env_config.new_backdoors_installed_reward_mult = 5
        env_config.new_tools_installed_reward_mult = 5
