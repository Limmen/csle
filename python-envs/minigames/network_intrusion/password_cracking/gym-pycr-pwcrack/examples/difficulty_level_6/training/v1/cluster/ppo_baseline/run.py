...
def default_config() -> ClientConfig:
    ...
    """
    agent_config = AgentConfig(gamma=0.995, alpha=0.00005, epsilon=1, render=False, eval_sleep=0.0,
    ...
    env_name = "pycr-pwcrack-level-6-cluster-v1"
    ...
    # cluster_config = ClusterConfig(server_ip="172.31.212.92", agent_ip="172.18.6.191",
    ...
    client_config = ClientConfig(env_name=env_name, agent_config=agent_config,
                                 ...
                                 title="PPO-Baseline level_6 v1",
                                 run_many=False, random_seeds=[0, 999, 299],
                                 random_seed=399, cluster_config=cluster_config, mode=RunnerMode.TRAIN_ATTACKER.value,
                                 randomized_env=False, eval_randomized_env=False, dummy_vec_env=False,
                                 sub_proc_env=False, multi_env=False, eval_multi_env=False
                                 )
