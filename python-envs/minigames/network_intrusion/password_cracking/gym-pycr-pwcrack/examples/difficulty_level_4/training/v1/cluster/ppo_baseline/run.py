...
def default_config() -> ClientConfig:
    ...
    #env_name = "pycr-pwcrack-level-4-cluster-v1"
    env_name = "pycr-pwcrack-level-4-cluster-costs-v1"
...
if __name__ == '__main__':
    ...
    experiment_title = "PPO level_4 v1 cluster"
