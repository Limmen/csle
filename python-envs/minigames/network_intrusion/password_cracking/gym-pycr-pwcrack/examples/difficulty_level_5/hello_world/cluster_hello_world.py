...
def test_env(env_name : str, num_steps : int):
    ...
    #                                server_username="kim")
    cluster_config = ClusterConfig(agent_ip="172.18.5.191", agent_username="agent", agent_pw="agent",
...
def test_all():
    #test_env("pycr-pwcrack-level-5-cluster-v1", num_steps=1000000000)
    test_env("pycr-pwcrack-level-5-cluster-v2", num_steps=1000000000)
