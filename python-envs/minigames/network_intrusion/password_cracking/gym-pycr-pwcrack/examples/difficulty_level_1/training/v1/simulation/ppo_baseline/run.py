...
import gym_pycr_pwcrack.util.experiments_util.plotting_util as plotting_util
...
def default_config() -> ClientConfig:
    ...
    agent_config = AgentConfig(gamma=1, alpha=0.0001, epsilon=1, render=False, eval_sleep=0.0,
                               ...
                               checkpoint_freq=150, input_dim=((max_num_nodes-1) * 3),
                               output_dim=7 + (3*(max_num_nodes-1)),
                               ...
                               lr_progress_decay=False, lr_progress_power_decay=4, ent_coef=0.0,
