...
def test_env(env_name : str, num_steps : int):
    ...
    containers_config = util.read_containers_config(
        "/home/kim/storage/workspace/pycr/cluster-envs/minigames/network_intrusion/password_cracking/001/random_many/env_0_172.18.6./containers.json")
    flags_config = util.read_flags_config(
        "/home/kim/storage/workspace/pycr/cluster-envs/minigames/network_intrusion/password_cracking/001/random_many/env_0_172.18.6./flags.json")
