...
if __name__ == '__main__':
    ...
    plotting_util.plot_mega(
        ...
        ylim_rew=(-0.5,1.5), file_name="mega_20_dr_20_1", markevery=100000, optimal_steps = 10, optimal_reward = 1, sample_step = 10,
        plot_opt=True, ylim_reg=(-0.5,20), ylim_step=(1, 15))
