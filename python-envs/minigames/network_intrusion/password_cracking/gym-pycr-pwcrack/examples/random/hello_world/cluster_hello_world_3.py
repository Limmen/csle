...
def test_env(env_name : str, num_steps : int):
    ...
    containers_config = util.read_containers_config(
        "/home/kim/pycr/cluster-envs/minigames/network_intrusion/password_cracking/001/random_many/env_7_172.18.19./containers.json")
    flags_config = util.read_flags_config(
        "/home/kim/pycr/cluster-envs/minigames/network_intrusion/password_cracking/001/random_many/env_7_172.18.19./flags.json")
    ...
    cluster_config = ClusterConfig(agent_ip=containers_config.agent_ip, agent_username="agent", agent_pw="agent",
                                   server_connection=False, port_forward_next_port=9900)
