...
def plot_rewards_steps_v1_v2_v3_v4():
    ppo_v1_df_0 = pd.read_csv(
        "/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/password_cracking/gym-pycr-pwcrack/examples/difficulty_level_2/training/v1/cluster/ppo_baseline/results/data/0/1605649073.721246_train.csv")
    ...
    ppo_v1_df_399 = pd.read_csv(
        "/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/password_cracking/gym-pycr-pwcrack/examples/difficulty_level_2/training/v1/cluster/ppo_baseline/results/data/399/1605649873.5459857_train.csv")
    ...
    ppo_v1_df_999 = pd.read_csv(
        "/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/password_cracking/gym-pycr-pwcrack/examples/difficulty_level_2/training/v1/cluster/ppo_baseline/results/data/999/1605649365.085521_train.csv")
    ...
    plotting_util.plot_rewards_steps_4(rewards_data_v1[0:200], rewards_means_v1[0:200], rewards_stds_v1[0:200],
                        ...
                        None, None, None, None, None, None, None, None, None,
                         ...
                         "42 actions", "100 actions", "90 actions", "155 actions", ylim_rew, ylim_step,
