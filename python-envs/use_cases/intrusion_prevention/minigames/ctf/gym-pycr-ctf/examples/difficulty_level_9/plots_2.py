...
def parse_data(novice_attacker_base_path: str, suffix: str, ips = None, eval_ips = None):
    ...
    train_defender_first_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_first_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    train_defender_first_stop_step_novice_attacker_means = np.mean(
        tuple(train_defender_first_stop_step_novice_attacker_data), axis=0)
    train_defender_first_stop_step_novice_attacker_stds = np.std(
        tuple(train_defender_first_stop_step_novice_attacker_data), axis=0, ddof=1)

    train_defender_second_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_second_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    train_defender_second_stop_step_novice_attacker_means = np.mean(
        tuple(train_defender_second_stop_step_novice_attacker_data), axis=0)
    train_defender_second_stop_step_novice_attacker_stds = np.std(
        tuple(train_defender_second_stop_step_novice_attacker_data), axis=0, ddof=1)

    train_defender_third_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_third_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    train_defender_third_stop_step_novice_attacker_means = np.mean(
        tuple(train_defender_third_stop_step_novice_attacker_data), axis=0)
    train_defender_third_stop_step_novice_attacker_stds = np.std(
        tuple(train_defender_third_stop_step_novice_attacker_data), axis=0, ddof=1)

    train_defender_fourth_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_fourth_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    train_defender_fourth_stop_step_novice_attacker_means = np.mean(
        tuple(train_defender_third_stop_step_novice_attacker_data), axis=0)
    train_defender_fourth_stop_step_novice_attacker_stds = np.std(
        tuple(train_defender_fourth_stop_step_novice_attacker_data), axis=0, ddof=1)

    train_defender_stops_remaining_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_stops_remaining"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    train_defender_stops_remaining_novice_attacker_means = np.mean(
        tuple(train_defender_stops_remaining_novice_attacker_data), axis=0)
    train_defender_stops_remaining_novice_attacker_stds = np.std(
        tuple(train_defender_stops_remaining_novice_attacker_data), axis=0, ddof=1)
    ...
    eval_defender_first_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_first_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_defender_first_stop_step_novice_attacker_means = np.mean(
        tuple(eval_defender_first_stop_step_novice_attacker_data), axis=0)
    eval_defender_first_stop_step_novice_attacker_stds = np.std(
        tuple(eval_defender_first_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_defender_second_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_second_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_defender_second_stop_step_novice_attacker_means = np.mean(
        tuple(eval_defender_second_stop_step_novice_attacker_data), axis=0)
    eval_defender_second_stop_step_novice_attacker_stds = np.std(
        tuple(eval_defender_second_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_defender_third_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_third_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_defender_third_stop_step_novice_attacker_means = np.mean(
        tuple(eval_defender_third_stop_step_novice_attacker_data), axis=0)
    eval_defender_third_stop_step_novice_attacker_stds = np.std(
        tuple(eval_defender_third_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_defender_fourth_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_fourth_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_defender_fourth_stop_step_novice_attacker_means = np.mean(
        tuple(eval_defender_third_stop_step_novice_attacker_data), axis=0)
    eval_defender_fourth_stop_step_novice_attacker_stds = np.std(
        tuple(eval_defender_fourth_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_defender_stops_remaining_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_stops_remaining"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_defender_stops_remaining_novice_attacker_means = np.mean(
        tuple(eval_defender_stops_remaining_novice_attacker_data), axis=0)
    eval_defender_stops_remaining_novice_attacker_stds = np.std(
        tuple(eval_defender_stops_remaining_novice_attacker_data), axis=0, ddof=1)
    ...
    eval_2_defender_first_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_first_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_2_defender_first_stop_step_novice_attacker_means = np.mean(
        tuple(eval_2_defender_first_stop_step_novice_attacker_data), axis=0)
    eval_2_defender_first_stop_step_novice_attacker_stds = np.std(
        tuple(eval_2_defender_first_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_2_defender_second_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_second_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_2_defender_second_stop_step_novice_attacker_means = np.mean(
        tuple(eval_2_defender_second_stop_step_novice_attacker_data), axis=0)
    eval_2_defender_second_stop_step_novice_attacker_stds = np.std(
        tuple(eval_2_defender_second_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_2_defender_third_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_third_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_2_defender_third_stop_step_novice_attacker_means = np.mean(
        tuple(eval_2_defender_third_stop_step_novice_attacker_data), axis=0)
    eval_2_defender_third_stop_step_novice_attacker_stds = np.std(
        tuple(eval_2_defender_third_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_2_defender_fourth_stop_step_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_fourth_stop_step"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_2_defender_fourth_stop_step_novice_attacker_means = np.mean(
        tuple(eval_2_defender_third_stop_step_novice_attacker_data), axis=0)
    eval_2_defender_fourth_stop_step_novice_attacker_stds = np.std(
        tuple(eval_2_defender_fourth_stop_step_novice_attacker_data), axis=0, ddof=1)

    eval_2_defender_stops_remaining_novice_attacker_data = list(
        map(lambda df: util.running_average_list(df["avg_defender_stops_remaining"].values[0:max_len],
                                                 running_avg),
            ppo_dfs_novice_attacker))
    eval_2_defender_stops_remaining_novice_attacker_means = np.mean(
        tuple(eval_2_defender_stops_remaining_novice_attacker_data), axis=0)
    eval_2_defender_stops_remaining_novice_attacker_stds = np.std(
        tuple(eval_2_defender_stops_remaining_novice_attacker_data), axis=0, ddof=1)
    ...
    return avg_train_rewards_data_novice_attacker, avg_train_rewards_means_novice_attacker, \
           ...
           train_defender_first_stop_step_novice_attacker_data, train_defender_first_stop_step_novice_attacker_means, \
           train_defender_first_stop_step_novice_attacker_stds, train_defender_second_stop_step_novice_attacker_data, \
           ...
           train_defender_stops_remaining_novice_attacker_stds, \
           ...
           eval_defender_first_stop_step_novice_attacker_data, eval_defender_first_stop_step_novice_attacker_means, \
           eval_defender_first_stop_step_novice_attacker_stds, eval_defender_second_stop_step_novice_attacker_data, \
           ...
           eval_defender_stops_remaining_novice_attacker_stds, \
           ...
           eval_2_defender_first_stop_step_novice_attacker_data, eval_2_defender_first_stop_step_novice_attacker_means, \
           eval_2_defender_first_stop_step_novice_attacker_stds, eval_2_defender_second_stop_step_novice_attacker_data, \
           ...
           eval_2_defender_stops_remaining_novice_attacker_stds
...
def plot_train(
    ...
    plotting_util_defender.plot_defender_simulation_emulation_tnsm_21(
        ...
        optimal_flag = 1.0, file_name = "defender_simulation_emulation_novice_attacker_multiple_stops_tnsm_21", markersize=2.25
    )

    plotting_util_defender.plot_defender_simulation_emulation_multiple_stops_tnsm_21(
        avg_rewards_data_simulation=avg_train_rewards_data_novice_attacker[0:max_iter],
        avg_rewards_means_simulation=avg_train_rewards_means_novice_attacker[0:max_iter],
        avg_rewards_stds_simulation=avg_train_rewards_stds_novice_attacker[0:max_iter],
        avg_steps_data_simulation=avg_train_steps_data_novice_attacker[0:max_iter],
        ...
        optimal_steps_means_simulation=avg_train_i_steps_means_novice_attacker[0:max_iter],
        optimal_steps_stds_simulation=avg_train_i_steps_stds_novice_attacker[0:max_iter],
        avg_first_stop_step_simulation_data = train_defender_first_stop_step_novice_attacker_data[0:max_iter],
        avg_first_stop_step_simulation_means=train_defender_first_stop_step_novice_attacker_means[0:max_iter],
        avg_first_stop_step_simulation_stds=train_defender_first_stop_step_novice_attacker_stds[0:max_iter],
        avg_second_stop_step_simulation_data=train_defender_second_stop_step_novice_attacker_data[0:max_iter],
        avg_second_stop_step_simulation_means=train_defender_second_stop_step_novice_attacker_means[0:max_iter],
        avg_second_stop_step_simulation_stds=train_defender_second_stop_step_novice_attacker_stds[0:max_iter],
        avg_third_stop_step_simulation_data=train_defender_third_stop_step_novice_attacker_data[0:max_iter],
        avg_third_stop_step_simulation_means=train_defender_third_stop_step_novice_attacker_means[0:max_iter],
        avg_third_stop_step_simulation_stds=train_defender_third_stop_step_novice_attacker_stds[0:max_iter],
        avg_fourth_stop_step_simulation_data=train_defender_fourth_stop_step_novice_attacker_data[0:max_iter],
        avg_fourth_stop_step_simulation_means=train_defender_fourth_stop_step_novice_attacker_means[0:max_iter],
        avg_fourth_stop_step_simulation_stds=train_defender_fourth_stop_step_novice_attacker_stds[0:max_iter],
        avg_stops_remaining_simulation_data=train_defender_stops_remaining_novice_attacker_data[0:max_iter],
        avg_stops_remaining_simulation_means=train_defender_stops_remaining_novice_attacker_means[0:max_iter],
        avg_stops_remaining_simulation_stds=train_defender_stops_remaining_novice_attacker_stds[0:max_iter],
        avg_rewards_data_emulation=avg_eval_2_rewards_data_novice_attacker[0:max_iter],
        avg_rewards_means_emulation=avg_eval_2_rewards_means_novice_attacker[0:max_iter],
        avg_rewards_stds_emulation=avg_eval_2_rewards_stds_novice_attacker[0:max_iter],
        avg_steps_data_emulation=avg_eval_2_steps_data_novice_attacker[0:max_iter],
        ...
        optimal_steps_means_emulation=avg_eval_2_i_steps_means_novice_attacker[0:max_iter],
        optimal_steps_stds_emulation=avg_eval_2_i_steps_stds_novice_attacker[0:max_iter],
        avg_first_stop_step_emulation_data=eval_2_defender_first_stop_step_novice_attacker_data[0:max_iter],
        avg_first_stop_step_emulation_means=eval_2_defender_first_stop_step_novice_attacker_means[0:max_iter],
        avg_first_stop_step_emulation_stds=eval_2_defender_first_stop_step_novice_attacker_stds[0:max_iter],
        avg_second_stop_step_emulation_data=eval_2_defender_second_stop_step_novice_attacker_data[0:max_iter],
        avg_second_stop_step_emulation_means=eval_2_defender_second_stop_step_novice_attacker_means[0:max_iter],
        avg_second_stop_step_emulation_stds=eval_2_defender_second_stop_step_novice_attacker_stds[0:max_iter],
        avg_third_stop_step_emulation_data=eval_2_defender_third_stop_step_novice_attacker_data[0:max_iter],
        avg_third_stop_step_emulation_means=eval_2_defender_third_stop_step_novice_attacker_means[0:max_iter],
        avg_third_stop_step_emulation_stds=eval_2_defender_third_stop_step_novice_attacker_stds[0:max_iter],
        avg_fourth_stop_step_emulation_data=eval_2_defender_fourth_stop_step_novice_attacker_data[0:max_iter],
        avg_fourth_stop_step_emulation_means=eval_2_defender_fourth_stop_step_novice_attacker_means[0:max_iter],
        avg_fourth_stop_step_emulation_stds=eval_2_defender_fourth_stop_step_novice_attacker_stds[0:max_iter],
        avg_stops_remaining_emulation_data=eval_2_defender_stops_remaining_novice_attacker_data[0:max_iter],
        avg_stops_remaining_emulation_means=eval_2_defender_stops_remaining_novice_attacker_means[0:max_iter],
        avg_stops_remaining_emulation_stds=eval_2_defender_stops_remaining_novice_attacker_stds[0:max_iter],
        ...
        fontsize=6.5, figsize=(7.5, 3), title_fontsize=8, lw=0.75, wspace=0.17, hspace=0.4, top=0.0,
        bottom=0.28, labelsize=6, markevery=10, optimal_reward=100, sample_step=5,
        eval_only=False, plot_opt=False, iterations_per_step=10, optimal_int=1.0,
        optimal_flag=1.0, file_name="defender_simulation_emulation_novice_attacker_multiple_stops_tnsm_21",
        markersize=2.25
    )
