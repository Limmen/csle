...
def parse_data(base_path: str, suffix: str, ips = None, eval_ips = None):
    ...
    ppo_v1_df_888 = pd.read_csv(glob.glob(base_path + "888/*_train.csv")[0])
    ppo_v1_df_210 = pd.read_csv(glob.glob(base_path + "210/*_train.csv")[0])
    ppo_v1_df_91 = pd.read_csv(glob.glob(base_path + "91/*_train.csv")[0])
    ppo_v1_df_110 = pd.read_csv(glob.glob(base_path + "110/*_train.csv")[0])
    ppo_v1_df_21 = pd.read_csv(glob.glob(base_path + "21/*_train.csv")[0])
    ppo_v1_df_111 = pd.read_csv(glob.glob(base_path + "111/*_train.csv")[0])
    ppo_v1_df_235 = pd.read_csv(glob.glob(base_path + "235/*_train.csv")[0])
    ppo_v1_df_52112 = pd.read_csv(glob.glob(base_path + "52112/*_train.csv")[0])
    #ppo_dfs_v1 = [ppo_v1_df_888, ppo_v1_df_210, ppo_v1_df_111, ppo_v1_df_235, ppo_v1_df_52112]
    ppo_dfs_v1 = [ppo_v1_df_888, ppo_v1_df_210, ppo_v1_df_52112]
...
if __name__ == '__main__':
    base_path = "/Users/kimham/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_9/results/data/"
