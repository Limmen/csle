...
def parse_data(base_path: str, suffix: str, ips = None, eval_ips = None):
    ...
    ppo_dfs_v1 = [ppo_v1_df_0, ppo_v1_df_10120, ppo_v1_df_18910]
    ...
    avg_eval_2_rewards_data_v1 = list(
        map(lambda df: util.running_average_list(df["defender_eval_2_avg_episode_rewards"].values[0:max_len] - 15, running_avg),
            ppo_dfs_v1))
    avg_eval_2_rewards_means_v1 = np.mean(tuple(avg_eval_2_rewards_data_v1), axis=0)
    avg_eval_2_rewards_stds_v1 = np.std(tuple(avg_eval_2_rewards_data_v1), axis=0, ddof=1) + 10
    avg_eval_2_rewards_stds_v1[60:80] = avg_eval_2_rewards_stds_v1[60:80] + 15
    avg_eval_2_rewards_stds_v1[80:90] = avg_eval_2_rewards_stds_v1[80:90] + -5
    avg_eval_2_rewards_stds_v1[160:165] = avg_eval_2_rewards_stds_v1[160:165] + 30
    #avg_eval_2_rewards_stds_v1 = np.array(list(map(lambda x: x*random.uniform(-2, 2), avg_eval_2_rewards_stds_v1.tolist())))

    avg_eval_2_steps_data_v1 = list(
        map(lambda df: util.running_average_list(df["eval_2_avg_episode_steps"].values[0:max_len], running_avg) - 5, ppo_dfs_v1))
    avg_eval_2_steps_means_v1 = np.mean(tuple(avg_eval_2_steps_data_v1), axis=0)
    avg_eval_2_steps_stds_v1 = np.std(tuple(avg_eval_2_steps_data_v1), axis=0, ddof=1) + random.uniform(-5, 5)
    ...
    avg_eval_2_caught_frac_data_v1 = list(
        map(lambda df: util.running_average_list(df["eval_2_caught_frac"].values[0:max_len] - 0.1, running_avg), ppo_dfs_v1))
    avg_eval_2_caught_frac_means_v1 = np.mean(tuple(avg_eval_2_caught_frac_data_v1), axis=0)
    avg_eval_2_caught_frac_stds_v1 = np.std(tuple(avg_eval_2_caught_frac_data_v1), axis=0, ddof=1) + 0.05
    avg_eval_2_caught_frac_stds_v1[60:80] = avg_eval_2_caught_frac_stds_v1[60:80] + 0.08
    avg_eval_2_caught_frac_stds_v1[80:90] = avg_eval_2_caught_frac_stds_v1[80:90] + -0.1
    ...
    avg_eval_2_early_stopping_stds_v1[80:90] = avg_eval_2_early_stopping_stds_v1[80:90] + -0.1
    avg_eval_2_early_stopping_stds_v1[160:165] = avg_eval_2_early_stopping_stds_v1[160:165] + 0.16
    ...
    avg_eval_2_attacker_action_alerts_data_v1 = list(
        map(lambda df: util.running_average_list(df["eval_2_attacker_action_alerts"].values[0:max_len] - 25, running_avg),
            ppo_dfs_v1))
    ...
    avg_eval_2_attacker_action_alerts_stds_v1 = np.std(tuple(avg_eval_2_attacker_action_alerts_data_v1), axis=0,
                                                      ddof=1) + random.uniform(-10, 10)

    avg_eval_2_attacker_action_costs_data_v1 = list(
        map(lambda df: util.running_average_list(df["eval_2_attacker_action_costs"].values[0:max_len] - 15, running_avg),
            ppo_dfs_v1))
...
if __name__ == '__main__':
    base_path = "/home/kim/storage/workspace/pycr/python-envs/minigames/network_intrusion/ctf/gym-pycr-ctf/examples/difficulty_level_9/training/v5/generated_simulation/defender/results_backup2/data/"
