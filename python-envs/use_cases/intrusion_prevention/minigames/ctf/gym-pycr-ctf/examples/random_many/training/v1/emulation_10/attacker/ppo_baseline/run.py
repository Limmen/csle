...
from pycr_common.util.plots import plotting_util_basic
...
def default_config() -> ClientConfig:
    ...
    emulation_configs = [
        EmulationConfig(agent_ip=containers_configs[idx].agent_ip, agent_username="agent", agent_pw="agent",
                        ...
                        port_forward_next_port=4001 + idx * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 1].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx+1) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 2].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 2) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 3].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 3) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 4].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 4) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 5].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 5) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 6].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 6) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 7].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 7) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 8].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 8) * 150,
                        warmup=True, warmup_iterations=500),
        EmulationConfig(agent_ip=containers_configs[idx + 9].agent_ip, agent_username="agent", agent_pw="agent",
                        server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
                        server_username="kim", server_ip="172.31.212.92",
                        port_forward_next_port=4001 + (idx + 9) * 150,
                        warmup=True, warmup_iterations=500)
    ]
    ...
    #                   server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
    #                   server_username="kim", server_ip="172.31.212.92",
    #                   port_forward_next_port=6001 + idx * 150,
    #                   warmup=True, warmup_iterations=500),
    #     EmulationConfig(agent_ip=eval_env_containers_configs[idx+1].agent_ip, agent_username="agent", agent_pw="agent",
    #                   server_connection=True, server_private_key_file="/home/kim/.ssh/id_rsa",
    #                   server_username="kim", server_ip="172.31.212.92",
    #                   port_forward_next_port=6001 + (idx+1) * 150,
    #                   warmup=True, warmup_iterations=500),
    # ]
    ...
    client_config = ClientConfig(env_name=env_name, attacker_agent_config=agent_config,
                                 ...
                                 containers_configs=[containers_configs[idx], containers_configs[idx+1], containers_configs[idx+2],
                                                     containers_configs[idx+3], containers_configs[idx+4], containers_configs[idx+5],
                                                     containers_configs[idx+6], containers_configs[idx+7], containers_configs[idx+8],
                                                     containers_configs[idx+9]],
                                 flags_configs=[flags_configs[idx], flags_configs[idx+1], flags_configs[idx+2],
                                                flags_configs[idx+3], flags_configs[idx+4], flags_configs[idx+5],
                                                flags_configs[idx+6], flags_configs[idx+7], flags_configs[idx+8],
                                                flags_configs[idx+9]],
        ...
        if args.csvfile is not None:
            ...
            for rd in rds:
                if config.run_many:
                    ...
                    #plotting_util_basic.plot_csv_files(csv_files, config.output_dir + "/" + rd + "/plots/")
                else:
                    p = glob.glob(config.output_dir + "/" + rd + "/data/" + str(config.random_seed) + "/*_train.csv")[0]
                    total_files.append([p])
                    # plotting_util_basic.plot_csv_files([p], config.output_dir + "/" + rd + "/plots/"
