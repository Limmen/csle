...
class EnvUtil:
    """
    Class with utility functions for the Pycr_CTF Environment
    """
    ...
    @staticmethod
    def is_attack_action_legal(attack_action_id: int, env_config: PyCREnvConfig, env_state: EnvState,
    ...
    @staticmethod
    def _is_attack_action_legal_m_selection(action_id: int, env_config: PyCREnvConfig, env_state: EnvState) -> bool:
        """
    ...
    @staticmethod
    def _is_attack_action_legal_m_action(action_id: int, env_config: PyCREnvConfig, env_state: EnvState, machine_index: int) \
            -> bool:
        """
    ...
    @staticmethod
    def compute_optimal_defender_reward(s: EnvState, env_config: PyCREnvConfig) -> Tuple[float, List[int], int]:
        """
