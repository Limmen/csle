...
class PyCRCTFNodeRandomizerConfig(PyCRNodeRandomizerConfig):
    ...
    def __init__(self, ip: str, reachable: Set[str], id: int, users_config: NodeUsersConfig,
                  ...
                  r_space: PyCrCTFRandomizationSpace,
                  router: bool = False, agent: bool = False, gateway: bool = False):
        """
        Creates a config DTO for randomizing a node in a PyCr-CTF env
