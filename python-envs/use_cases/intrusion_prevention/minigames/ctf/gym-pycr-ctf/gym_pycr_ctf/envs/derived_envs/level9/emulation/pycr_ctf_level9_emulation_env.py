...
class PyCRCTFLevel9Emulation5Env(PyCRCTFEnv):
    """
    ...
    def __init__(self, env_config: PyCREnvConfig, emulation_config: EmulationConfig, checkpoint_dir : str):
        if env_config is None:
            ...
            attacker_action_conf = PyCrCTFLevel9V5.attacker_actions_conf(num_nodes=PyCrCTFLevel9Base.num_nodes(),
                                                                subnet_mask=PyCrCTFLevel9Base.subnet_mask(),
                                                                hacker_ip=PyCrCTFLevel9Base.hacker_ip())
            defender_action_conf = PyCrCTFLevel9V5.defender_actions_conf(
                num_nodes=PyCrCTFLevel9Base.num_nodes(), subnet_mask=PyCrCTFLevel9Base.subnet_mask())
...
class PyCRCTFLevel9Emulation6Env(PyCRCTFEnv):
    """
    ...
    def __init__(self, env_config: PyCREnvConfig, emulation_config: EmulationConfig, checkpoint_dir: str):
        if env_config is None:
            ...
            attacker_action_conf = PyCrCTFLevel9V6.attacker_actions_conf(num_nodes=PyCrCTFLevel9Base.num_nodes(),
                                                                         subnet_mask=PyCrCTFLevel9Base.subnet_mask(),
                                                                         hacker_ip=PyCrCTFLevel9Base.hacker_ip())
            defender_action_conf = PyCrCTFLevel9V6.defender_actions_conf(
                num_nodes=PyCrCTFLevel9Base.num_nodes(), subnet_mask=PyCrCTFLevel9Base.subnet_mask())
