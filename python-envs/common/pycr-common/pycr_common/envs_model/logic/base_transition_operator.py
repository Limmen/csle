...
class BaseTransitionOperator(ABC):
    ...
    @staticmethod
    @abstractmethod
    def attacker_transition(s: BaseEnvState, attacker_action: BaseAttackerAction, env_config: BasePyCREnvConfig) -> \
            Tuple[BaseEnvState, float, bool]:
        pass

    @staticmethod
    @staticmethod
    def defender_transition(s: BaseEnvState, defender_action: BaseDefenderAction, env_config: BasePyCREnvConfig,
