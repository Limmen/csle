...
class DefenderStoppingUtil:
    ...
    @staticmethod
    def stop_monitor(s: EnvState, a: DefenderAction, env_config: PyCREnvConfig) -> Tuple[EnvState, float, bool]:
        """
    ...
    @staticmethod
    def continue_monitor(s: EnvState, a: DefenderAction, env_config: PyCREnvConfig) -> Tuple[EnvState, float, bool]:
        """
