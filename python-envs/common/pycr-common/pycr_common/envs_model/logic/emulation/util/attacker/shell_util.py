...
class ShellUtil:
    ...
    @staticmethod
    def _find_flag_using_ssh(machine: AttackerMachineObservationState, env_config: PyCREnvConfig, a: AttackerAction,
    ...
    @staticmethod
    def _find_flag_using_telnet(machine: AttackerMachineObservationState, env_config: PyCREnvConfig, a: AttackerAction,
    ...
    @staticmethod
    def _find_flag_using_ftp(machine: AttackerMachineObservationState, env_config: PyCREnvConfig, a: AttackerAction,
                             new_m_obs: AttackerMachineObservationState) \
            -> Tuple[AttackerMachineObservationState, float, bool, Tuple]:
        """
    ...
    @staticmethod
    def parse_tools_installed_file(file_name: str, env_config: PyCREnvConfig) -> List[str]:
        """
    ...
    @staticmethod
    def install_tools_helper(s: EnvState, a: AttackerAction, env_config: PyCREnvConfig) -> Tuple[EnvState, float, bool]:
        """
    ...
    @staticmethod
    def execute_ssh_backdoor_helper(s: EnvState, a: AttackerAction, env_config: PyCREnvConfig) \
    ...
    @staticmethod
    def execute_service_login_helper(s: EnvState, a: AttackerAction, env_config: PyCREnvConfig) \
            -> Tuple[EnvState, float, bool]:
        """
