...
const TabularPolicies = (props) => {
    ...
    const fetchTabularPolicy = useCallback((tabular_policy_id) => {
        fetch(
            (`${API_BASE_URL}/${TABULAR_POLICIES_RESOURCE}/${tabular_policy_id.value}`
    ...
    const fetchTabularPoliciesIds = useCallback(() => {
        fetch(
            `${API_BASE_URL}/${TABULAR_POLICIES_RESOURCE}?${IDS_QUERY_PARAM}=true`
            + `&${TOKEN_QUERY_PARAM}=${props.sessionData.token}`,
            {
                method: HTTP_REST_GET,
                headers: new Headers({
    ...
    const removeTabularPoliciesRequest = useCallback((tabular_policy_id) => {
        fetch(
            `${API_BASE_URL}/${TABULAR_POLICIES_RESOURCE}/${tabular_policy_id}`
            + `?${TOKEN_QUERY_PARAM}=${props.sessionData.token}`,
            {
    ...
    const removeAllTabularPoliciesRequest = useCallback(() => {
        fetch(
            `${API_BASE_URL}/${TABULAR_POLICIES_RESOURCE}`
            + `?${TOKEN_QUERY_PARAM}=${props.sessionData.token}`,
            {
                method: HTTP_REST_DELETE,
                headers: new Headers({
