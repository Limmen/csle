...
import './VectorPolicyComponent.css';
 ...
 */
const VectorPolicyComponent = (props) => {
...
VectorPolicyComponent.propTypes = {};
VectorPolicyComponent.defaultProps = {};
export default VectorPolicyComponent;
