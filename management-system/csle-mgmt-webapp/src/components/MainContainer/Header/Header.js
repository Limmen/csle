...
const Header = (props) => {
  ...
  const renderRecoveryAITooltip = (props) => (
    <Tooltip id="button-tooltip" {...props} className="toolTipRefresh">
      Decision-support system for recovering from cyberattacks, powered by AI
    </Tooltip>
  )
            ...
            <li className="nav-item dropdown navtabheader">
              ...
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <OverlayTrigger
                  placement="right"
                  delay={{ show: 0, hide: 0 }}
                  overlay={renderRecoveryAITooltip}>
                  <NavLink className="dropdown-item" to={RECOVERY_AI_PAGE_RESOURCE}>
                    Recovery AI <i className="fa fa-android headerIcon" aria-hidden="true"></i>
                  </NavLink>
                </OverlayTrigger>
              </div>
            </li>
